export const CONCIERGE_CONFIG_JSON = {
  "metadata": {
  ...
  "text": {
    ...
    "disclaimer.text": "AI responses may be inaccurate. Check answers and sources. Terms"
  },
  "arrays": {
    "welcome.examples": [
      {
  ...
  "theme": {
    ...
    "--input-outline-color": "rgba(113, 85, 250, 0.6)",
