        ...
        var executeRequest = function executeRequest() {
          var retriesAttempted =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : 0;
          return networkStrategy(url, stringifiedPayload).then(function(
            response
          ) {
            if (
      ...
      return {
        setConsent: function setConsent(consentByPurpose) {
          switch (consentByPurpose[GENERAL]) {
            ...
            default:
              logger.warn(
                "Unknown consent value: " + consentByPurpose[GENERAL]
              );
              break;
          }
        },
...
*/
    ...
    var injectEnsureSingleIdentity = function(_ref) {
      ...
      var allowRequestToGoWithoutIdentity = function allowRequestToGoWithoutIdentity(
        payload
      ) {
...
*/
    ...
    var createAudiences = function createAudiences(_ref) {
      ...
      var processDestinationsFromResponse = function processDestinationsFromResponse(
        _ref2
      ) {
        ...
        lifecycle: {
          onBeforeEvent: function onBeforeEvent(_ref2) {
            var event = _ref2.event,
              ...
              decisionScopes =
                _ref2$decisionScopes === void 0 ? [] : _ref2$decisionScopes,
              _ref2$onResponse = _ref2.onResponse,
              onResponse =
                _ref2$onResponse === void 0 ? noop : _ref2$onResponse,
              _ref2$onRequestFailur = _ref2.onRequestFailure,
              onRequestFailure =
                _ref2$onRequestFailur === void 0 ? noop : _ref2$onRequestFailur;
...
*/
    ...
    var getDecisionScopes = function getDecisionScopes(
      renderDecisions,
      decisionScopes
    ) {
...
*/
    ...
    var createComponent$3 = function(_ref) {
      ...
      var consentByPurpose = reactorObjectAssign(
...
*/
    var createCoreConfigs = function() {
      return {
        ...
        edgeConfigId: boundString()
          .unique()
          .required(),
        edgeDomain: boundString()
          .domain()
          .default(EDGE$1),
      ...
      return function(_ref2) {
        var payload = _ref2.payload,
          ...
          runOnResponseCallbacks =
            _ref2$runOnResponseCa === void 0 ? noop : _ref2$runOnResponseCa,
          _ref2$runOnRequestFai = _ref2.runOnRequestFailureCallbacks,
          runOnRequestFailureCallbacks =
            _ref2$runOnRequestFai === void 0 ? noop : _ref2$runOnRequestFai;
        var onResponseCallbackAggregator = createCallbackAggregator();
        ...
        return lifecycle
          ...
          .then(function() {
            var endpointDomain = payload.getUseIdThirdPartyDomain()
              ? ID_THIRD_PARTY
              : edgeDomain;
            var requestId = v4_1();
            var url =
