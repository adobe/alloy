...
!(function() {
  ...
  if (document.documentMode && document.documentMode < 11)
    ...
    var e = "Chrome",
      ...
      f = (function() {
        ...
        ? Object.assign
        : function(e, n) {
            for (var t, r, o = xo(e), i = 1; i < arguments.length; i++) {
    ...
    var v = function(e) {
      ...
      m = function(e) {
        return !v(e) && !Array.isArray(e) && "object" === No(e);
      },
      h = function e(n, t) {
      ...
      x = function(e) {
        ...
        return new Promise(function(e, t) {
          S(k, { src: n }, { onload: e, onerror: t, onabort: t }, [], r);
        });
      },
      q = function(e) {
      ...
      B = function(e, n) {
        if (!window.document.documentElement.attachShadow)
          return N(e, n.replace(T, ""));
        var t = (function(e) {
          return e.split(T);
        })(n);
        if (t.length < 2) return N(e, n);
      ...
      K = x,
      Y = { name: "Adobe Alloy" },
      Z = { style: { display: "none", width: 0, height: 0 } },
      ee = function(e) {
          ...
          ? (function(e) {
              ...
              return G("BODY")
                ...
                .then(function(e) {
                  ...
                  return x({ src: n, currentDocument: t }).then(function() {
                    $(e);
                  });
                });
            })({ src: t })
    ...
    var Pe = function(e, n) {
      ...
      je = function(e, n) {
        return Me(q(e), e, n, "a function"), e;
      },
      Te = function(e, n) {
        return function(t, r) {
          return Me(t >= n, t, r, e + " greater than or equal to " + n), t;
        };
      },
      Ue = function(e) {
        return function(n, t) {
          return m(n) ? Me(!fe(n), n, t, e) : Me(n.length > 0, n, t, e), n;
        };
      },
      Be = /^[a-z0-9.-]{1,}$/i,
      Fe = function(e, n) {
        return Me(Be.test(e), e, n, "a valid domain"), e;
      },
      _e = function(e, n) {
        return Me(le(e), e, n, "an integer"), e;
      },
      He = function(e, n) {
        return Me(de(e), e, n, "a number"), e;
      },
      Ve = function(e, n) {
        return (
          Me(
    ...
    var Je = function() {
      ...
      rn = function(e) {
        return Ae(
          ...
          (function(e) {
            return function(n, t) {
              Me(Array.isArray(n), n, t, "an array");
              var r = [],
    ...
    (jn.namespace = "ActivityCollector"), (jn.configValidators = Mn);
    var Tn,
      Un,
      Bn,
      Fn = function(e, n) {
      ...
      Xn =
        ((Tn = function(o) {
          var i, a;
          return (jo((i = {}), n, /Edge\/([0-9\._]+)/),
          jo(i, t, /Edg\/([0-9\.]+)/),
          jo(i, e, /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/),
          jo(i, "Firefox", /Firefox\/([0-9\.]+)(?:\s|$)/),
          jo(i, "IE", /Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/),
          jo(i, "Safari", /Version\/([0-9\._]+).*Safari/),
          (a = i),
          function(e) {
      ...
      ot = function(e) {
        var n = e.config,
          ...
          u = Wn({ logger: t, orgId: i, awaitVisitorOptIn: zn }),
          s = Ln({ config: n, getEcidFromVisitor: u }),
          f = ce({ orgId: i }),
          l = (function(e) {
          ...
          })({ getLegacyEcid: s.getEcid, addEcidToPayload: Gn }),
          v = (function(e) {
            var n = e.orgId,
          ...
          })({ fireReferrerHideableImage: ee, logger: t }),
          y = (function(e) {
    ...
    var it = function(e, n) {
      ...
      ut = function(e) {
        var n = e.logger,
          t = at({ fireReferrerHideableImage: ee, logger: n });
        return {
          lifecycle: { onResponse: ct({ processDestinations: t }) },
          commands: {}
        };
      };
    ...
    var st,
      ...
      Tt = function(e) {
        if (e && !Dt(Mt)) {
          var n = At(),
            t = Mo({ id: Mt }, n && { nonce: n }),
            r = S(O, t, { textContent: e });
          D(document.head, r);
        }
      },
      Ut = function() {
      ...
      zt = setTimeout;
    (zo.prototype.catch = function(e) {
      return this.then(null, e);
    }),
      (zo.prototype.then = function(e, n) {
        var t = new this.constructor(Lo);
        return Wo(this, new Go(e, n, t)), t;
      }),
      ...
      (zo.all = function(e) {
        return new zo(function(n, t) {
          if (!Vo(e)) return t(new TypeError("Promise.all accepts an array"));
          var r = Array.prototype.slice.call(e);
          if (0 === r.length) return n([]);
          var o = r.length;
          function i(e, a) {
            try {
              if (a && ("object" === No(a) || "function" == typeof a)) {
                var c = a.then;
      ...
      (zo.resolve = function(e) {
        return e && "object" === No(e) && e.constructor === zo
          ? e
          : new zo(function(n) {
              n(e);
            });
      }),
      (zo.reject = function(e) {
        return new zo(function(n, t) {
          t(e);
        });
      }),
      (zo.race = function(e) {
        return new zo(function(n, t) {
          if (!Vo(e)) return t(new TypeError("Promise.race accepts an array"));
          for (var r = 0, o = e.length; r < o; r++) zo.resolve(e[r]).then(n, t);
        });
      }),
      (zo._immediateFn =
      ...
      (zo._unhandledRejectionFn = function(e) {
    ...
    var Wt,
      Jt =
        ((Wt = Object.freeze({ __proto__: null, default: zo })) &&
          Wt.default) ||
        Wt,
      Qt =
      ...
      Yt = function(e) {
        for (
          ...
          if ($t(c)) {
            var u = c.textContent;
            u && t.push(S(P, i, { textContent: u }));
          }
        }
        return t;
      },
      Zt = function(e) {
        for (var n = _(P, e), t = [], r = n.length, o = 0; o < r; o += 1) {
          var i = n[o];
          if (Kt(i)) {
            var a = St(i, Ft);
            a && t.push(a);
          ...
          return (
            (function(e) {
              if (!Nt[e]) {
                var n = At(),
                  t = Mo({}, n && { nonce: n }),
                  r = S(O, t, { textContent: e + " { visibility: hidden }" });
                D(document.head, r), (Nt[e] = r);
              }
            })(r),
            G(t, It)
              .then(function(n) {
      ...
      xr = function(e) {
        ...
        return (
          e.forEach(function(e) {
            var n = e.items,
              r = Uo(Or(void 0 === n ? [] : n, t), 2),
              a = r[0],
              c = r[1];
            A(a) && o.push(Pr(e, a)), A(c) && i.push(Pr(e, c));
          }),
      ...
      qr = function(e) {
        var n = xr(e, gt),
          t = xr(n.unmatchedDecisions, lt, dt),
          r = (function(e) {
            var n = [],
              t = [],
              r = {};
          ...
          a = r.viewScopeDecisions;
        return {
          redirectDecisions: n.matchedDecisions,
          pageWideScopeDecisions: o,
          viewDecisions: a,
          nonAutoRenderableDecisions: t.unmatchedDecisions.concat(i)
        };
      },
      Ar = function() {
        var e = {};
      ...
      Nr = function(e) {
        var n,
              ...
              return Promise.resolve(a)
                ...
                .then(function(e) {
                  return (
                    ...
                    r(),
                    [].concat(
                      Bo(e.pageWideScopeDecisions),
                      Bo(e.viewPropositions)
                    )
                  );
                })
                .then(function(e) {
                  return {
                    decisions: Bo(c),
                    propositions: [].concat(
                      Bo(Sr({ decisions: e, renderAttempted: !0 })),
                      Bo(Sr({ decisions: c, renderAttempted: !1 }))
                    )
                  };
                });
            };
          ...
          m = (function(e) {
            ...
            nonRenderingHandler: Mr({ viewCache: f }),
            groupDecisions: qr,
    ...
    (Nr.namespace = "Personalization"),
      (Nr.configValidators = { prehidingStyle: fn().nonEmpty() });
    var jr,
      Tr = "2.9.0",
      Ur = (function(e) {
        return function(n) {
    ...
    var io,
      ao,
      co = [qn, jn, ot, ut, Nr, zr, Zr, no, to, oo],
      uo = function(e) {
        var n = e.options,
  ...
  function Fo(e, n) {
    if (e) {
      if ("string" == typeof e) return _o(e, n);
        ...
        zo._immediateFn(function() {
          ...
          if (null !== t) {
            ...
            try {
              ...
              return void Qo(n.promise, e);
            }
            Jo(n.promise, r);
          } else (1 === e._state ? Jo : Qo)(n.promise, e._value);
        }))
      : e._deferreds.push(n);
  }
  function Jo(e, n) {
    try {
      ...
      if (n && ("object" === No(n) || "function" == typeof n)) {
        var t = n.then;
        if (n instanceof zo) return (e._state = 3), (e._value = n), void Xo(e);
      ...
      (e._state = 1), (e._value = n), Xo(e);
    } catch (n) {
      Qo(e, n);
    }
  }
  function Qo(e, n) {
    (e._state = 2), (e._value = n), Xo(e);
  }
  function Xo(e) {
    2 === e._state &&
      0 === e._deferreds.length &&
      zo._immediateFn(function() {
        e._handled || zo._unhandledRejectionFn(e._value);
      });
    for (var n = 0, t = e._deferreds.length; n < t; n++) Wo(e, e._deferreds[n]);
    e._deferreds = null;
  }
  function Go(e, n, t) {
