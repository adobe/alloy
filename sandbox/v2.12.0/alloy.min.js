...
!(function() {
  ...
  if (document.documentMode && document.documentMode < 11)
    ...
    (function() {
      return Ne(this, Ve, { minimum: Ge, integer: Ke, unique: tn });
    }.bind(Qe));
    var dn = function(e) {
        return Ne(
          this,
    ...
    var Bn,
      ...
      $n =
        ((Bn = function(o) {
          var i, a;
          return (Lo((i = {}), n, /Edge\/([0-9\._]+)/),
          Lo(i, t, /Edg\/([0-9\.]+)/),
          Lo(i, e, /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/),
          Lo(i, "Firefox", /Firefox\/([0-9\.]+)(?:\s|$)/),
          Lo(i, "IE", /Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/),
          Lo(i, "Safari", /Version\/([0-9\._]+).*Safari/),
          (a = i),
          function(e) {
    ...
    (ct.namespace = "Identity"), (ct.configValidators = Ln);
    var ut = function(e, n) {
        return (
    ...
    var Hr,
      ...
      Xr = { web: Vr, device: zr, environment: Jr, placeContext: Wr },
      $r = [
        Qr,
        function(e) {
          y(e, {
    ...
    var uo = function(e) {
      var n = (function(e) {
        var n = e.config,
          ...
          r = [].concat(Jo(t.getCommandNames()), [xn, qn]).sort(),
          o = _o({}, n);
        return (
          Object.keys(n).forEach(function(e) {
            var t = n[e];
          ...
          { version: Lr, configs: o, commands: r }
        );
                    ...
                    return (
                      ...
                      t
                        ...
                        .catch(function(e) {
                          ...
                          return h.call({ error: e }).then(n, n);
                        })
                        .then(function(e) {
                          var n = e.parsedBody,
                            t = e.getHeader,
