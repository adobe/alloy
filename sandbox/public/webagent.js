...
:root {
  ...
  --concierge-message-bg: #e8e8e8; /* Light gray for concierge */
  --user-message-bg: #304cb2; /* Adobe blue for user */
  --user-message-text: white; /* White text for user messages */
  --concierge-message-text: black;
...
.message-blocker {
  background: linear-gradient(0deg, rgb(255, 255, 255) 120px, rgba(255, 255, 255, 0) 144px);
  position: absolute;
  bottom: 0;
  left: 0;
  right: 0;
...
// API configuration
const API_ENDPOINT = "https://experience-platform-aep-gen-ai-assistant-exp154.corp.ethos12-stage-va7.ethos.adobe.net/copilot/chats";
/**
...
async function sendChatMessage(message) {
    try {
        ...
        // Fall back to direct API call if WebSDK is not available
        // Use the API endpoint directly without query parameters
        const url = API_ENDPOINT;
        // Format the message as required by the API
        ...
        const response = await fetch(url, {
            method: "POST",
            headers: {
                "Content-Type": "application/vnd.adobe.copilot.v1+json;charset=UTF-8",
                "x-api-key": "bc-api-key",
                "x-gw-ims-org-id": "E38130325FF373D60A494210@AdobeOrg",
            },
        ...
        // Extract the first response from the interaction
        if (data?.interaction?.response?.length > 0) {
            return data.interaction.response[0];
        }
        // If we can't find the expected structure, throw an error
...
class CardCarousel {
    ...
    createCarouselElement() {
        ...
        this.navContainer.className = "carousel-navigation-arrows";
        this.prevButton = document.createElement("button");
        this.prevButton.className = "carousel-navigation-arrow prev";
        this.prevButton.setAttribute("aria-label", "Previous cards");
        this.prevButton.innerHTML = getPrevArrowSVG();
        this.nextButton = document.createElement("button");
        this.nextButton.className = "carousel-navigation-arrow next";
...
class WelcomePanel {
    ...
    createPanelElement() {
        ...
        container.className = "example-messages welcome-panel";
        // Create heading
        const heading = document.createElement("h2");
        heading.className = "example-heading";
        heading.innerHTML = "Wanna get away?  We're here to help.";
        container.appendChild(heading);
        // Create subheading
        const subheading = document.createElement("p");
        subheading.className = "example-subheading";
        subheading.textContent = "You can type in your questions or click on a suggestion to get started.";
        ...
        // Create carousel for mobile view
        if (this.examples.length > 0) {
            this.carousel = new CardCarousel({
                items: this.examples,
                onItemSelect: (text) => this.onExampleSelect(text),
            });
            container.appendChild(this.carousel.getElement());
        }
        return container;
    }
}
...
class InputBar {
    ...
    constructor(options) {
        this.options = {
            placeholder: "Describe where you wanna go",
            ...options,
        };
...
function createChatInterface(options) {
    ...
    const examples = [
        {
            text: "I'd like to plan a dream vacation",
            image: "https://www.southwest.com/swa-resources/images/polaroids/homepage/GettyImages-1152205822.png",
            backgroundColor: "#1a2c80",
        },
        {
            text: "I want to find the best car rental for my trip",
            image: "https://www.southwest.com/swa-resources/images/polaroids/homepage/HpPolo2-car-20200114-2.jpg",
            backgroundColor: "#1a2c80",
        },
        {
            text: "I'm looking to book the perfect hotel",
            image: "https://www.southwest.com/swa-resources/images/polaroids/homepage/HpPolo3-hotel-20200114.jpg",
            backgroundColor: "#1a2c80",
        },
        {
            text: "I want to book the cruise of a lifetime",
            image: "https://www.southwest.com/swa-resources/images/polaroids/homepage/HpPolo-IMG-Cruises-20241106.jpg",
            backgroundColor: "#1a2c80",
        },
    ];
    ...
    container.appendChild(welcomePanel.getElement());
...
function createInputSection(onSubmit, exampleMessagesElement) {
    ...
    disclaimer.className = "disclaimer-message";
    disclaimer.textContent = "AI responses may be inaccurate or misleading. Be sure to double check answers and sources.";
 ...
 */
function addMessageToHistory(historyElement, message, sender) {
...
function addLoadingIndicator(historyElement) {
    ...
    const loadingMessages = [
        "Hang tight — we're just taxiing to your answer...",
        "Your info's boarding now. We'll be right with you!",
        "Grabbing your answer from the overhead bin...",
        "Just a sec — we're cruising at 30,000 feet to find that...",
        "Checking your itinerary for the perfect response...",
        "Your answer's coming in for a smooth landing...",
        "Finding the comfiest seat for your info...",
        "Serving up some LUV with your answer — just a moment!",
    ];
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/styles/chatClient.css
var chatClient = __webpack_require__(717);
;// ./src/styles/chatClient.css
...
var chatClient_options = {};

chatClient_options.styleTagTransform = (styleTagTransform_default());
chatClient_options.setAttributes = (setAttributesWithoutAttributes_default());

      chatClient_options.insert = insertBySelector_default().bind(null, "head");
    
chatClient_options.domAPI = (styleDomAPI_default());
chatClient_options.insertStyleElement = (insertStyleElement_default());

var update = injectStylesIntoStyleTag_default()(chatClient/* default */.A, chatClient_options);




       /* harmony default export */ const styles_chatClient = (chatClient/* default */.A && chatClient/* default */.A.locals ? chatClient/* default */.A.locals : undefined);
