...
const AlloyPersonlization = () => {
  ...
  return (
    <>
      <h2 className={appStyles}>Render personalized content</h2>
      <p>
        Adobe Experience Platform Web SDK supports retrieving personalized
        content from personalization solutions at Adobe, including Adobe Target
        and Offer Decisioning. Content created within Adobe Target’s Visual
        Experience Composer can be retrieved and rendered automatically by the
        SDK. Content created within Adobe Target’s Form-based Experience
        Composer or Offer Decisioning cannot be rendered automatically by the
        SDK. Instead, you must request this content using the SDK and then
        manually render the content yourself.
      </p>
...
export default AlloyPersonlization;
