...
const AlloyConfiguration = () => {
  ...
  const makeAPICall = async e => {
    ...
    alloyInstance("config", alloyOptions);
  };
              ...
              {activeTab === "tester" && (
                <div>
                  <input
                    ...
                    type="text"
                    value={alloyOptions.edgeConfigId}
                    onChange={e =>
                      setAlloyOptions({
                        ...alloyOptions,
                        edgeConfigId: e.target.value
                      })
                    }
                  ></input>
                </div>
              ...
              {activeTab === "tester" && (
                <div>
                  <input
                    ...
                    type="text"
                    onChange={e => updateInput(setAlloyOptions, e.target.value)}
                  ></input>
                </div>
              )}
              <div>
