...
!(function() {
  ...
  if (document.documentMode && document.documentMode < 11)
    ...
    var e = "Chrome",
      ...
      f = (function() {
        ...
        ? Object.assign
        : function(e, n) {
            for (var t, r, o = yo(e), i = 1; i < arguments.length; i++) {
      ...
      v = function(e) {
        return !p(e) && !Array.isArray(e) && "object" === Eo(e);
      },
      m = function e(n, t) {
      ...
      q = function(e) {
        ...
        return new Promise(function(e, t) {
          R(k, { src: n }, { onload: e, onerror: t, onabort: t }, [], r);
        });
      },
      P = function(e) {
    ...
    (Rn.namespace = "DataCollector"), (Rn.configValidators = {});
    var kn = function(e) {
        var n = e.config,
          t = e.eventManager,
          r = e.lifecycle,
    ...
    var qn,
      ...
      Hn =
        ((qn = function(o) {
          var i, a;
          return (Io((i = {}), n, /Edge\/([0-9\._]+)/),
          Io(i, t, /Edg\/([0-9\.]+)/),
          Io(i, e, /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/),
          Io(i, "Firefox", /Firefox\/([0-9\.]+)(?:\s|$)/),
          Io(i, "IE", /Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/),
          Io(i, "Safari", /Version\/([0-9\._]+).*Safari/),
          (a = i),
          function(e) {
    ...
    (Gn.namespace = "Identity"), (Gn.configValidators = jn);
    var Kn = function(e, n) {
        return (
      ...
      et = function(e) {
        ...
        return {
          lifecycle: { onResponse: Zn({ processDestinations: t }) },
          commands: {}
        };
      };
    (et.namespace = "Audiences"), (et.configValidators = {});
    var nt,
      tt = "__view__",
      rt = "https://ns.adobe.com/personalization/dom-action",
      ot = "https://ns.adobe.com/personalization/redirect-item",
      it = function(e) {
        var n = e.logger,
              ...
              var m = (function(e) {
                ...
                return {
                  ...
                  createQueryDetails: function() {
                    var e = ko(t);
                    this.isCacheInitialized() || o(e, tt) || e.push(tt);
                    var n = [
                    ...
                    return (
                      o(e, tt) && n.push(rt), { schemas: n, decisionScopes: e }
                    );
                  },
      ...
      gt = function(e) {
        for (
          var n = [],
            t = (function(e) {
              return e.split(ut).filter(ue);
            })(
              (function(e) {
                return e.replace(ft, lt);
              })(e.trim())
            ),
            r = t.length,
            o = 0;
      ...
      It = function() {
        ...
        if (void 0 === nt) {
          ...
          nt = n && (n.nonce || n.getAttribute("nonce"));
        }
        return nt;
      },
      Dt = "alloy-prehiding",
      ...
      St = function(e) {
        if (e && !vt(Dt)) {
          var n = It(),
            t = Co({ id: Dt }, n && { nonce: n }),
            r = R(S, t, { textContent: e });
          I(document.head, r);
        }
      },
      Ot = function() {
    ...
    (Ao.prototype.catch = function(e) {
      ...
      (Ao.prototype.then = function(e, n) {
        var t = new this.constructor(Po);
        return Mo(this, new Uo(e, n, t)), t;
      }),
      (Ao.prototype.finally = function(e) {
      ...
      (Ao.all = function(e) {
        return new Ao(function(n, t) {
          if (!qo(e)) return t(new TypeError("Promise.all accepts an array"));
          var r = Array.prototype.slice.call(e);
          if (0 === r.length) return n([]);
          var o = r.length;
          function i(e, a) {
            try {
              if (a && ("object" === Eo(a) || "function" == typeof a)) {
                var c = a.then;
      ...
      (Ao.resolve = function(e) {
        return e && "object" === Eo(e) && e.constructor === Ao
          ? e
          : new Ao(function(n) {
              n(e);
            });
      ...
      (Ao.race = function(e) {
        return new Ao(function(n, t) {
          if (!qo(e)) return t(new TypeError("Promise.race accepts an array"));
          for (var r = 0, o = e.length; r < o; r++) Ao.resolve(e[r]).then(n, t);
        });
      }),
      (Ao._immediateFn =
      ...
      (Ao._unhandledRejectionFn = function(e) {
    ...
    var Nt,
      Tt =
        ((Nt = Object.freeze({ __proto__: null, default: Ao })) &&
          Nt.default) ||
        Nt,
      Ut =
      ...
      Ht = function(e) {
        for (
          ...
          if (_t(c)) {
            var u = c.textContent;
            u && t.push(R(O, i, { textContent: u }));
          }
        }
        return t;
      },
      Lt = function(e) {
        for (var n = j(O, e), t = [], r = n.length, o = 0; o < r; o += 1) {
          var i = n[o];
          if (Vt(i)) {
            var a = ht(i, x);
            a && t.push(a);
          ...
          return (
            (function(e) {
              if (!Rt[e]) {
                var n = It(),
                  t = Co({}, n && { nonce: n }),
                  r = R(S, t, { textContent: e + " { visibility: hidden }" });
      ...
      pr = function(e, n) {
        e.mergeQuery({ personalization: Co({}, n) });
      },
      vr = function(e) {
        var n = e.decisions,
          t = e.renderAttempted;
        ...
        return (
          e.forEach(function(e) {
            var o = e.items,
              ...
              a = i[0],
              c = i[1];
            A(a) && t.push(mr(e, a)), A(c) && r.push(mr(e, c));
          }),
          ...
          return Promise.resolve(a)
            ...
            .then(function(e) {
              return (function(e) {
                ...
                return {
                  decisions: n,
                  propositions: vr({ decisions: n, renderAttempted: !1 })
                };
              })({ propositions: e });
            });
        };
      ...
      Cr = function(e) {
        var n,
          ...
          })({ eventManager: i, mergeDecisionsMeta: gr }),
          c = (function(e) {
            var n = e.eventManager,
              t = e.mergeDecisionsMeta;
            return function(e) {
          ...
          p = rr(l),
          v = ur({ modules: p, logger: o, executeActions: ar, collect: a }),
          m = ur({ modules: p, logger: o, executeActions: ar, collect: c }),
          h = (function(e) {
            var n = e.collect,
              t = e.window,
              r = e.logger,
          ...
          })({ collect: a, window: window, logger: o, showContainers: Ot }),
          y = (function(e) {
          ...
          w = (function(e) {
            ...
            responseHandler: (function(e) {
                  ...
                  return i
                        ...
                        return (
                          ...
                          o(),
                          {
                            ...
                            propositions: [].concat(
                              ko(
                                vr({
                                  decisions: [].concat(ko(a), ko(e)),
                                  renderAttempted: !0
                                })
                              ),
                              ko(vr({ decisions: c, renderAttempted: !1 }))
                            )
                          }
                        );
                      })
                    : (t(a),
                      o(),
                      {
                        decisions: ko(c),
                        propositions: [].concat(
                          ko(vr({ decisions: a, renderAttempted: !0 })),
                          ko(vr({ decisions: c, renderAttempted: !1 }))
                        )
                      });
                };
              ...
              nonRenderingHandler: br({ viewCache: g }),
              groupDecisions: yr,
        ...
        return it({
          ...
          viewChangeHandler: E,
          onClickHandler: b,
          isAuthoringModeEnabled: lr,
          mergeQuery: pr,
          viewCache: g
        });
      };
    (Cr.namespace = "Personalization"),
      (Cr.configValidators = { prehidingStyle: rn().nonEmpty() });
    var Er,
      Ir = "2.7.0",
      Dr = (function(e) {
        return function(n) {
      ...
      xr = { web: Dr, device: Rr, environment: kr, placeContext: Sr },
      qr = [
        Or,
        function(e) {
          h(e, {
      ...
      Pr = function(e) {
        ...
        })(e.config, e.logger, xr, qr);
      };
    (Pr.namespace = "Context"),
      (Pr.configValidators = { context: Ke(rn()).default(Object.keys(xr)) });
    var Ar = function e(n) {
      ...
      Fr = function(e) {
        var n,
          ...
          })({ parseConsentCookie: Ur, orgId: c, cookieJar: g }),
          f =
            ((n = 0),
            (t = Promise.resolve()),
            {
          ...
          d = (function(e) {
            ...
            createConsentRequestPayload: Nr,
            createConsentRequest: Tr,
              ...
              lookup: function(e) {
                var t = {},
                  r = function(e) {
                    ...
                    var r = Do(e, ["standard", "version"]);
                    return t[n] || (t[n] = Mr(r).toString()), t[n];
                  };
                return {
                  isNew: function() {
        ...
        return (function(e) {
          ...
          validateSetConsentOptions: Br,
          consentHashStore: l,
          doesIdentityCookieExist: p
        });
      };
    Fr.namespace = "Privacy";
    var _r = function() {
        return { eventMergeId: De() };
      },
      Vr = function() {
        return {
          commands: {
            createEventMergeId: {
              run: { createEventMergeId: _r }.createEventMergeId
            }
          }
        };
      };
    (Vr.namespace = "EventMerge"), (Vr.configValidators = {});
    var Hr = function() {
      return {
        commands: {
          getLibraryInfo: {
            run: function() {
              return { libraryInfo: { version: Ir } };
            }
          }
        }
      };
    ...
    var Lr = function(e) {
      ...
      zr = function() {
        return { lifecycle: { onResponse: Lr }, commands: {} };
      };
    (zr.namespace = "MachineLearning"), (zr.configValidators = {});
    var Jr,
      Wr,
      Xr = [Rn, xn, Gn, et, Cr, Pr, Fr, Vr, Hr, zr],
      Qr = function(e) {
        var n = e.options,
      ...
      to = "The server responded with a",
      ro = [429, 503, 502, 504],
      oo = function(e) {
        var n = e.response;
        return e.retriesAttempted < 3 && o(ro, n.statusCode);
      },
      io = function(e) {
        var n = e.response,
      ...
      ao =
        ...
        function(e) {
          var n = G + e;
          return {
            session: te(Jr, "sessionStorage", n),
            persistent: te(Jr, "localStorage", n)
          };
        }),
      co = window,
      uo = co.console,
      ...
      ho = function(e) {
        var n = e.instanceName,
          ...
          a = dn(),
          c = sn(a),
          u = Gr({ errorPrefix: "[" + n + "]", logger: o });
        return In({
          logger: o,
          configureCommand: function(e) {
            var t = Qr({
                options: e,
                componentCreators: Xr,
                coreConfigValidators: po,
                createConfig: $r,
                logger: o,
                setDebugEnabled: r
              }),
              u = Zr({ cookieJar: g, orgId: t.orgId, apexDomain: vo }),
              s = P(fo.sendBeacon)
                ? (function(e) {
                    var n = e.sendBeacon,
              ...
              d = (function(e) {
                      ...
                      return (s ? r : t)(c, f).then(function(t) {
                        ...
                        return (
                          n.logOnNetworkResponse(
                            Co(
                              Co({ requestId: a, url: c, payload: d }, t),
                              {},
                ...
                sendFetchRequest: mo,
                sendBeaconRequest: s,
                isRequestRetryable: oo,
                getRequestRetryDelay: io
              }),
              l = (function(e) {
                var n = e.logger;
                return function(e) {
              ...
              h = (function(e) {
                  ...
                  sendEvent: function(e) {
                    ...
                    return r
                      ...
                      .then(function() {
                        ...
                        if (!e.shouldSend()) {
                          v.add(r.onRequestFailure), t.info(Yr);
                          var o = new Error(Yr);
                ...
                consent: m,
                createEvent: Cn,
                createDataCollectionRequestPayload: eo,
    ...
    (Wr = window.__alloyNS) &&
      Wr.forEach(function(e) {
        var n = cn({
          ...
          })(ho({ instanceName: e, logController: n })),
          r = window[e].q;
        (r.push = t),
  ...
  function So(e, n) {
    if (e) {
      if ("string" == typeof e) return Oo(e, n);
        ...
        Ao._immediateFn(function() {
          ...
          if (null !== t) {
            ...
            try {
              ...
              return void No(n.promise, e);
            }
            jo(n.promise, r);
          } else (1 === e._state ? jo : No)(n.promise, e._value);
        }))
      : e._deferreds.push(n);
  }
  function jo(e, n) {
    try {
      ...
      if (n && ("object" === Eo(n) || "function" == typeof n)) {
        var t = n.then;
        if (n instanceof Ao) return (e._state = 3), (e._value = n), void To(e);
      ...
      (e._state = 1), (e._value = n), To(e);
    } catch (n) {
      No(e, n);
    }
  }
  function No(e, n) {
    (e._state = 2), (e._value = n), To(e);
  }
  function To(e) {
    2 === e._state &&
      0 === e._deferreds.length &&
      Ao._immediateFn(function() {
        e._handled || Ao._unhandledRejectionFn(e._value);
      });
    for (var n = 0, t = e._deferreds.length; n < t; n++) Mo(e, e._deferreds[n]);
    e._deferreds = null;
  }
  function Uo(e, n, t) {
