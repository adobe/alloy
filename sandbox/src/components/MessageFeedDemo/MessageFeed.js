...
export default function MessageFeed() {
  ...
  useEffect(() => {
                        ...
                        consequences: [
                          {
                            ...
                            detail: {
                              mobileParameters: {
                                ...
                                gestures: {
                                  swipeUp:
                                    "adbinapp://dismiss?interaction=swipeUp",
                                  swipeDown:
                            ...
                            detail: {
                              ...
                              data: {
                                ...
                                content: {
                                  ...
                                  actionUrl: "https://luma.com/sale",
                                  body:
                                    "Great job, you completed your profile.",
    ...
    async function applyRuleEngineResponse() {
    ...
    document
      .getElementById("social-media-share")
    ...
    document.getElementById("deposit-funds").addEventListener("click", evt => {
      evt.stopImmediatePropagation();
      evt.preventDefault();
    ...
    document.getElementById("magic").addEventListener("click", evt => {
      evt.stopImmediatePropagation();
      evt.preventDefault();
    ...
    const fetchData = async () => {
      try {
        const result = await window.alloy("subscribeMessageFeed", {
          surface: "web://target.jasonwaters.dev/aep.html",
          callback: ({ items = [], clicked, rendered }) => {
            if (isMounted) {
  ...
  return (
    <div>
      ...
      <div style={{ margin: "10px 0" }}>
        <button id="social-media-share">Share on social media</button>
        <button id="deposit-funds">Deposit funds</button>
      ...
      <div style={{ margin: "30px 0" }}>
        ...
        <div id="message-feed">
          {messageFeedItems.map((item, index) => (
            <div key={index} className="pretty-card">
              <p>{item.title}</p>
              <p>
