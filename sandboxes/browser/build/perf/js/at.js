...
(window.adobe = window.adobe || {}),
  (window.adobe.target = (function () {
    ...
    var l = (function () {
      ...
      : function (t, n) {
          for (var e, r, o = f(t), i = 1; i < arguments.length; i++) {
            for (var u in (e = Object(arguments[i])))
              a.call(e, u) && (o[u] = e[u]);
            if (c) {
              r = c(e);
              for (var l = 0; l < r.length; l++)
                s.call(e, r[l]) && (o[r[l]] = e[r[l]]);
            }
          }
          return o;
        };
    ...
    function P(t) {
      ...
      return function () {
        for (
          ...
          i[u] = arguments[u];
        for (var c = e ? t[r].apply(n, i) : i[0]; (r += 1) < e; )
          c = t[r].call(n, c);
        return c;
      };
    }
      ...
      return p(t)
        ...
        : V(t)
          ? D(t)
            ? t.split("")
            : (function (t) {
                for (var n = 0, e = t.length, r = Array(e); n < e; )
                  (r[n] = t[n]), (n += 1);
                return r;
              })(t)
          : ((n = k(t)),
    ...
    function pt() {
      ...
      return "xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g, function (n) {
        var e,
          ...
          o =
            (t +
              ((r = 16), (e = 0) + Math.floor(Math.random() * (r - e + 1)))) %
              16 |
            0;
        return (
    ...
    function So(t, n, e, r) {
      n === He && t[ze].push(e),
        r && n !== He && t[ze][n].push(l({ timestamp: at() }, e));
    }
    function Co(t) {
      So(i, $e, t, ho());
    }
    var ko = Dr(function (t) {
      ...
      Oo = (function (t) {
        var n = (function () {
          ...
          function M(t) {
            return (
              L(t) && !j(t) && Object.getPrototypeOf(t) == Object.prototype
            );
          }
          function V(t) {
          ...
          return (
            ...
            (I.init = function (t, e) {
              ...
              if ("string" == typeof t)
                ...
                if (P(t))
                  ...
                  (o = I.fragment(t.trim(), RegExp.$1, e)), (t = null);
                else {
                  if (e !== n) return r(e).find(t);
                  o = I.qsa(l, t);
                }
            ...
            (r.fn = {
              ...
              parents: function (t) {
                for (var n = [], e = this; e.length > 0; )
                  e = r.map(e, function (t) {
                    if ((t = t.parentNode) && !D(t) && n.indexOf(t) < 0)
                      return n.push(t), t;
                  });
                return Z(n, t);
              },
              ...
              wrap: function (t) {
                ...
                return this.each(function (i) {
                  r(this).wrapAll(
                    n ? t.call(this, i) : o ? e.cloneNode(!0) : e,
                  );
                });
              },
              wrapAll: function (t) {
              ...
              offset: function (n) {
                if (n)
                  return this.each(function (t) {
                    ...
                    "static" == e.css("position") && (u.position = "relative"),
                      e.css(u);
                  });
              ...
              position: function () {
                if (this.length) {
                  ...
                  return (
                    ...
                    (o.left +=
                      parseFloat(r(n[0]).css("border-left-width")) || 0),
            ...
            ["after", "prepend", "before", "append"].forEach(function (t, e) {
              ...
              (r.fn[t] = function () {
                ...
                (r.fn[o ? t + "To" : "insert" + (e ? "Before" : "After")] =
                  function (n) {
          ...
          (function (n) {
              ...
              r.split(/\s/).forEach(function (r) {
                ...
                (c.proxy = function (n) {
                  if (!(n = S(n)).isImmediatePropagationStopped()) {
                    ...
                    var r = f.apply(
                      t,
                      n._args == e ? [n] : [n].concat(n._args),
                    );
                    return (
                      !1 === r && (n.preventDefault(), n.stopPropagation()), r
                    );
                  }
                }),
                  (c.i = v.length),
            ...
            (a.click = a.mousedown = a.mouseup = a.mousemove = "MouseEvents"),
              ...
              (n.proxy = function (t, e) {
                ...
                if (u(e))
                  return r
                    ? (r.unshift(t[e], t), n.proxy.apply(null, r))
                    : n.proxy(t[e], t);
            ...
            (n.fn.delegate = function (t, n, e) {
              ...
              (n.fn.trigger = function (t, e) {
                return (
                  ((t = u(t) || n.isPlainObject(t) ? n.Event(t) : S(t))._args =
                    e),
                  this.each(function () {
                  ...
                  this.each(function (i, c) {
                    ((r = C(u(t) ? n.Event(t) : t))._args = e),
                      ...
                      n.each(v(c, t.type || t), function (t, n) {
                        if (
                          ((o = n.proxy(r)), r.isImmediatePropagationStopped())
                        )
                          return !1;
                      });
                  }),
    ...
    function Ec(t, n) {
      ...
      return (
        H(r) || (e.audienceManager = r),
        H(t.analytics) || (e.analytics = t.analytics),
        e
      );
    }
    function Sc(t, n) {
    ...
    function Nc(t, n) {
      var e = t.index,
        ...
        i = Oc(t, l({}, n, Ju(r)));
      return (
        p(e) || (i.index = e), nt(r) && (i.name = r), H(o) || (i.address = o), i
      );
    }
    function Ic(t, n) {
      var e = t.prefetch,
    ...
    function rs(t) {
      var n = Rr()[ge],
        ...
        i = {},
        u = {};
      e === n ? (u.pageLoad = {}) : (u.mboxes = [{ index: 0, name: e }]),
        (i.execute = u);
      var c = _c(e, i);
      if (!H(c)) {
        var a = {};
        ...
        case At:
          return (function (t) {
            var n = t[mt],
              e = xi(t[Ct]);
            return (
              xo(Pn, t), Co({ action: t }), ss(cn, e), as(cn, xs(n), e), Ro(t)
            );
          })(n);
        case Pt:
          return Ls(n);
    ...
    function wl(t) {
      var n =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : bf;
      if (p(t)) return [null];
      var e = ut(ml, t);
    ...
    function El(t) {
      var n =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Ef;
      if (p(t)) return [null];
      var e = ut(gl, [t]);
          ...
          q(function (n) {
            if (n.type === rn) {
              var e = Tt,
                r = n.content;
              (n.type = oe),
                (n.content = [{ type: e, selector: t, content: r }]);
            }
          }, e);
      }
    }
    ...
    function Gl(t) {
      var n = (function (t) {
        ...
        e = n[Gn];
      if (!n[Yn])
        return bo(Zl, e), void Co({ source: Zl, options: t, error: e });
      if (!po())
        return (
          d(t[Gn](Kn, hn)),
          bo(Zl, hn),
          void Co({ source: Zl, options: t, error: hn })
        );
      var r = function (n) {
          return Jl(t, n);
        },
    ...
    function Xl(t) {
      ...
      return n[Yn]
        ? po()
          ...
          : (bo(Kl, hn),
            Co({ source: Kl, options: t, error: hn }),
            jo(new Error(hn)))
    ...
    function td(t) {
      ...
      return e[Yn]
        ? po()
          ...
          : (bo(Ql, hn),
            Co({ source: Ql, options: t, error: hn }),
            ql(n),
            jo(new Error(hn)))
        : (bo(Ql, t, r),
          Co({ source: Ql, options: t, error: r }),
          ql(n),
          jo(e));
    }
    ...
    function ed(t) {
      var n = Rr()[ge],
        ...
        u = i[Gn];
      if (!i[Yn])
        return bo(nd, u), void Co({ source: nd, options: t, error: u });
      if (!po())
        return bo(nd, hn), void Co({ source: nd, options: t, error: hn });
    ...
    function od(t) {
      ...
      !(function (t) {
        var n = t.mbox,
          ...
          o = or,
          i = hf(Oc({}, r), o, []);
        if (((i.mbox = { name: n }), mf(pf(n, r, [i]))))
          return xo(Hn, t), void t[Wn]();
        bo(zn, t), t[Gn](Xn, zn);
      })(t);
    }
    function id(t) {
    ...
    function ud(t) {
      var n = (function (t) {
        ...
        e = n[Gn];
      if (!n[Yn])
        return bo(rd, e), void Co({ source: rd, options: t, error: e });
      var r = (function (t, n) {
        var e = n[Qn],
          r = l({}, n),
      ...
      if (!po())
        return (
          bo(rd, hn),
          d(r[Gn](Kn, hn)),
          void Co({ source: rd, options: t, error: hn })
        );
      xo(rd, r),
    ...
    function hd(t, n) {
      if (!D(t) || Z(t))
        return bo(cd, sr, t), void Co({ source: cd, view: t, error: sr });
      var e = t.toLowerCase(),
        r = (function (t, n) {
          var e = {};
          return (
