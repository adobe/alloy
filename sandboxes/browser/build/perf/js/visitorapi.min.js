/**
 * @license
 * Adobe Visitor API for JavaScript version: 5.1.0
...
var e = (function () {
  ...
  function l() {
    ...
    (this.log = Se("log", e, t)),
      (this.warn = Se("warn", e, t)),
      (this.error = Se("error", e, t));
  }
  function d() {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      t = e.cookieName,
  ...
  function p() {
    ...
    function n(e) {
      return function (n, i) {
        ...
        return O(de.CHANGED), Object.assign(b, ke(be(n), e)), i || t(), h;
      };
    }
  ...
  var I,
    ...
    F = function () {
      ...
      Object.keys(N).forEach(n, this), Object.keys(x).forEach(i, this);
    },
    j = L.ASYNC_API_MAP,
    V = function () {
    ...
    pe = ((I = {}), t(I, fe.AAM, 565), t(I, fe.ECID, 565), I),
    ge = ((S = {}), t(S, fe.AAM, [1, 10]), t(S, fe.ECID, [1, 10]), S),
    ...
    be = function (e, t) {
      return e instanceof Array ? e : Ae(e, "string") ? [e] : t || [];
    },
    Oe = function (e) {
      var t = Object.keys(e);
      return (
    ...
    we = function (e) {
      return null !== e && Ae(e, "object") && !1 === Array.isArray(e);
    },
    Ne = function () {},
    xe = function (e) {
  ...
  var Je = function (t, n, i) {
    ...
    function o(e) {
      function t(e, t, n) {
        e && e.match(oe.VALID_VISITOR_ID_REGEX) && (n === E && (A = !0), t(e));
      }
      t(e[E], I.setMarketingCloudVisitorID, E),
        I._setFieldExpire(N, -1),
    ...
    (I.FIELDS = L.FIELDS),
      ...
      (I.cookieWrite = function (e, t, n) {
        var i = I.cookieLifetime ? ("" + I.cookieLifetime).toUpperCase() : "",
          r = { expires: n, domain: I.cookieDomain, cookieLifetime: i };
        return (
          I.configs &&
            ...
            (r.secure = !0),
          I.configs &&
            I.configs.sameSiteCookie &&
            "https:" === location.protocol &&
            (r.sameSite =
              L.SAME_SITE_VALUES[I.configs.sameSiteCookie.toUpperCase()] ||
              "Lax"),
          Z.set(e, "" + t, r)
        );
      }),
        ...
        if (
          ...
          if (
            ...
            var i = I._getAudienceManagerURLData(),
              r = i.url;
            return (
              I._customerIDsHashChanged && I._setFieldExpire(N, -1),
              I._getRemoteField(N, r, e, t, i)
            );
          }
        }
        return "";
    ...
    (I._liberatedOptOut = null),
      (I.getOptOut = function (e, t) {
        ...
        return (
          ...
          (C[r] = function (e) {
            ...
            I._callAllCallbacks("liberatedOptOut", [t]), (H = !1);
          }),
          j.fireCORS(n),
          null
        );
      ...
      (I._parseAdobeMcFromUrl = a(oe.ADOBE_MC)),
      (I._parseAdobeMcSdidFromUrl = a(oe.ADOBE_MC_SDID)),
        ...
        if (!I._readVisitorDone) {
          ...
          if (
            (c ||
              ...
              (c = I.cookieRead(oe.FIRST_PARTY_SERVER_COOKIE)),
          ...
          !I._getField(R) &&
            ...
            c.length > 1 &&
              ...
              i && i.match(oe.VALID_VISITOR_ID_REGEX) && I._setField(R, i)));
        }
      }),
      (I._appendVersionTo = function (e) {
        ...
        return (
          n
            ? te.areVersionsDifferent(n, I.version) &&
      ...
      (I._setFieldMap = function (e, t, n) {
        ...
        if (t) {
          r = [];
          for (i in t) F(i) && (r.push(i), r.push(t[i]));
        }
                ...
                : t.visitorID
                  ...
                  : t.id
                    ...
                    : t.uuid
                      ? t.uuid
                      : "" + t),
            t && "NOTARGET" === (t = t.toUpperCase()) && (t = x),
            (t && (t === x || t.match(oe.VALID_VISITOR_ID_REGEX))) || (t = "")),
          t
        );
      }),
      (I._setFields = function (t, n) {
        ...
        if (t === w && "object" === e(n)) {
          ...
          var a = G.getRegionAndCheckIfChanged(n, r);
          I._callAllCallbacks("MCAAMLH", [a]);
          var o = I._getField(N);
          (n.d_blob || n.blob) &&
            ((o = n.d_blob),
            o || (o = n.blob),
            I._setFieldExpire(N, r),
            I._setField(N, o)),
            o || (o = ""),
            I._callAllCallbacks(N, [o]),
            !n.error_msg &&
              I._newCustomerIDsHash &&
        ...
        if (t === P) {
          ...
          (s && !I.overwriteCrossDomainMCIDAndAID) ||
            ...
            s ? s !== x && I._setFieldExpire(N, -1) : (s = x),
            I._setField(R, s)),
            (s && s !== x) || (s = ""),
            I._callAllCallbacks(R, [s]);
        }
        if (I.idSyncDisableSyncs || I.disableIdSyncs)
          G.idCallNotProcesssed = !0;
        else {
          G.idCallNotProcesssed = !1;
          var c = {};
          (c.ibs = n.ibs), (c.subdomain = n.subdomain), G.processIDCallData(c);
        }
        if (n === Object(n)) {
          var u, l;
          d() && I.isAllowed() && (u = I._getField("MCOPTOUT"));
          var f = U.parseOptOut(n, u, x);
          (u = f.optOut),
            (l = f.d_ottl),
      ...
      (I._setAnalyticsFields = function (e) {
        I._readVisitor(), I._setFields(P, e);
      }),
      ...
      (I._getAudienceManagerURLData = function (e) {
        var t = I.audienceManagerServer,
          ...
          r = I._getField(N, !0),
          a = I._getField(R),
          o = a && a !== x ? "&d_cid_ic=AVID%01" + encodeURIComponent(a) : "";
        if (
          (I.loadSSL &&
            I.audienceManagerServerSecure &&
      ...
      (I.appendVisitorIDsTo = function (e) {
        try {
          ...
          return I._addQuerystringParam(e, oe.ADOBE_MC, c(t));
        } catch (t) {
          return e;
        }
      }),
      (I.appendSupplementalDataIDTo = function (e, t) {
        ...
        try {
          ...
          return I._addQuerystringParam(e, oe.ADOBE_MC_SDID, n);
        } catch (t) {
          return e;
        }
      });
    var B = {
      ...
      removeCookie: function (e) {
        Z.remove(e, { domain: I.cookieDomain });
      },
    ...
    I._helpers = B;
    var G = se(I, O);
    (I._destinationPublishing = G), (I.timeoutMetricsLog = []);
    var q = {
    ...
    (I.isClientSideMarketingCloudVisitorID = function () {
      ...
      (I._resetAmcvCookie = function (e) {
        ...
        (t && !te.isLessThan(t, e)) || B.removeCookie(I.cookieName);
      }),
      ...
      (function () {
        if (((I.configs = Object.create(null)), B.isObject(n)))
          for (var e in n) F(e) && ((I[e] = n[e]), (I.configs[e] = n[e]));
      })(),
      f();
    var X;
    I.init = function () {
        ...
        (function () {
          if (B.isObject(n)) {
            ...
            I.idSyncDisableSyncs ||
              I.disableIdSyncs ||
              !G.canMakeSyncIDCall(e, t) ||
              (I._setFieldExpire(N, -1), I._setField(T, t)),
  ...
  return (
    (ze.getInstance = function (e, t) {
      ...
      var r = e,
        ...
        o = new ze(e, null, a);
      U.isObject(i) && i.cookieDomain && (o.cookieDomain = i.cookieDomain),
        (function () {
