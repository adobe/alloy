  ...
  "function" != typeof window.DIL &&
    ((window.DIL = function (n) {
      ...
      E.IS_IE_LESS_THAN_10 =
        "number" == typeof E.IE_VERSION && E.IE_VERSION < 10;
      var P = { stuffed: {} },
        L = {},
        A = {
          firingQueue: [],
          ...
          adms: {
            ...
            process: function (e) {
              try {
                ...
                if (
                  (n = e.getInstance(t, { idSyncContainerID: r })) !==
                    Object(n) ||
      ...
      var q,
        ...
        M = {
          traits: function (e) {
            return (
              k.isValidPdata(e) &&
                (L.sids instanceof Array || (L.sids = []),
          ...
          pixels: function (e) {
            return (
              k.isValidPdata(e) &&
                (L.pdata instanceof Array || (L.pdata = []),
          ...
          customQueryParams: function (e) {
            return (
              k.isEmptyObject(e) || x.extendObject(L, e, A.reservedKeys), this
            );
          },
          ...
          submit: function (e) {
            return (
              (L.isDefaultRequest = !!e), V.submitRequest(L), (L = {}), this
            );
          },
          getPartner: function () {
            return I;
          ...
          setCookie: function (e, t, n, s, i, r) {
            ...
            (n = n && 1e3 * n * 60),
              (document.cookie =
                ...
                (n
                  ? ";expires=" + new Date(o.getTime() + n).toUTCString()
                  : "") +
                (s ? ";path=" + s : "") +
                (i ? ";domain=" + i : "") +
                (r ? ";secure" : ""));
      ...
      E.IS_IE_LESS_THAN_10 &&
        ...
        (this.initConfig = n),
        (this.logger = R),
        w && ((this.variables = P), (this.callWindowLoadFunctions = G));
    }),
