    ...
    extensions: {
      core: {
          ...
          "core/src/lib/events/helpers/pageLifecycleEvents.js": {
            script: function (module, exports, require, turbine) {
              ...
              var processTrigger = function (nativeEvent, triggerData) {
                ...
                trigger(
                  syntheticEventFn ? syntheticEventFn(nativeEvent) : null,
                );
              };

              window._satellite = window._satellite || {};
              window._satellite.pageBottom = processRegistry.bind(
                null,
                PAGE_BOTTOM,
              );
        ...
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/07c2a9012ef3/6232856ef9ff/hostedLibFiles/EP2e2f86ba46954a2b8a2b3bb72276b9f8/",
      },
      "adobe-alloy": {
              ...
              module.exports = function (_ref) {
                ...
                return function (settings) {
                  var instanceName = settings.instanceName,
                    otherSettings = _objectWithoutProperties(settings, [
                      "instanceName",
                    ]);
                  ...
                  return instance("sendEvent", otherSettings).then(
                    function (result) {
                      if (result.decisions) {
...
*/
                ...
                if (document.documentMode && document.documentMode < 11) {
                  ...
                  (function () {
                    ...
                    function _interopDefaultLegacy(e) {
                      return e && _typeof2(e) === "object" && "default" in e
                        ? e
                        : {
                            default: e,
                          };
                    ...
                    var assign__default =
                      /*#__PURE__*/ _interopDefaultLegacy(assign);

                    var cookie__default =
                      /*#__PURE__*/ _interopDefaultLegacy(cookie);

                    var queryString__default =
                      /*#__PURE__*/ _interopDefaultLegacy(queryString);

                    var loadScript__default =
                      /*#__PURE__*/ _interopDefaultLegacy(loadScript);
                    /*
      Copyright 2019 Adobe. All rights reserved.
      This file is licensed to you under the Apache License, Version 2.0 (the "License");
      you may not use this file except in compliance with the License. You may obtain a copy
      ...
      */
                    ...
                    var createInstance = function createInstance(
                      ...
                      return function (args) {
                        ...
                        executeCommand(commandName, options).then(
                          resolve,
                          reject,
                        );
                      };
      ...
      */
                    ...
                    var areThirdPartyCookiesSupportedByDefault =
                      function areThirdPartyCookiesSupportedByDefault(browser) {
                        return includes(
                          browsersSupportingThirdPartyCookie,
                          browser,
                        );
                      };
                    /*
      ...
      */
                    ...
                    var convertTimes = function convertTimes(
                      fromUnit,
                      toUnit,
                      amount,
                    ) {
      ...
      */
                    ...
                    var deepAssignObject = function deepAssignObject(
                      target,
                      source,
                    ) {
      ...
      */
                    ...
                    var createMerger = function createMerger(content, key) {
                      return function (updates) {
                        ...
                        var hostObjectForUpdates = propertyPath.reduce(
      ...
      */
                    ...
                    var createCallbackAggregator =
                      function createCallbackAggregator() {
                        var callbacks = [];
                        return {
      ...
      */
                    ...
                    var populateElementProperties =
                      function populateElementProperties(element, props) {
      ...
      */
                    ...
                    var fireImage = function fireImage(_ref) {
                      var src = _ref.src,
                        ...
                        currentDocument =
                          _ref$currentDocument === void 0
                            ? document
                            : _ref$currentDocument;
      ...
      */
                    ...
                    var awaitUsingMutationObserver =
                      function awaitUsingMutationObserver(
                        win,
                        doc,
                        selector,
                        timeout,
                    ...
                    var canUseRequestAnimationFrame =
                      function canUseRequestAnimationFrame(doc) {
                        return doc[VISIBILITY_STATE] === VISIBLE;
                      };

                    var awaitUsingRequestAnimation =
                      function awaitUsingRequestAnimation(
                        win,
                        selector,
                        timeout,
                        selectFunc,
                    ...
                    var awaitSelector = function awaitSelector(selector) {
                      ...
                      if (canUseRequestAnimationFrame(doc)) {
                        return awaitUsingRequestAnimation(
                          win,
                          selector,
                          timeout,
                          selectFunc,
      ...
      */
                    ...
                    var matchesSelector = function matchesSelector(
                      selector,
                      element,
                    ) {
                      if (element.matches) {
      ...
      */
                    ...
                    var fireReferrerHideableImage =
                      function fireReferrerHideableImage(request) {
                        var createIframe = function createIframe() {
                          return awaitSelector(BODY).then(function (_ref) {
                            var _ref2 = _slicedToArray(_ref, 1),
                              body = _ref2[0];

                            var iframe = createNode(
                              IFRAME,
                              IFRAME_ATTRS,
                              IFRAME_PROPS,
                            );
      ...
      */
                    ...
                    var getLastArrayItems = function getLastArrayItems(
                      arr,
                      itemCount,
                    ) {
      ...
      */
                    ...
                    var getApexDomain = function getApexDomain(
                      window,
                      cookieJar,
                    ) {
                      var topLevelCookieDomain = ""; // If hostParts.length === 1, we may be on localhost.

                      var hostParts = window.location.hostname
                        .toLowerCase()
                        .split(".");
                      var i = 1;
                      ...
                      while (
                        ...
                        i += 1;
                        topLevelCookieDomain = getLastArrayItems(
                          hostParts,
                          i,
                        ).join(".");
      ...
      */
                    ...
                    var sanitizeOrgIdForCookieName =
                      function sanitizeOrgIdForCookieName(orgId) {
      ...
      */
                    ...
                    var getNamespacedCookieName =
                      function getNamespacedCookieName(orgId, key) {
                        return (
                          COOKIE_NAME_PREFIX +
                          "_" +
                          sanitizeOrgIdForCookieName(orgId) +
                          "_" +
                          key
                        );
                      };
      ...
      */
                    ...
                    var isNamespacedCookieName =
                      function isNamespacedCookieName(orgId, name) {
                        return (
                          name.indexOf(
                            COOKIE_NAME_PREFIX +
                              "_" +
      ...
      */
                    ...
                    var padStart = function padStart(
                      ...
                      return (
                        repeatedPadString.slice(0, lengthToAdd) + originalString
                      );
                    };
                    /*
      Copyright 2019 Adobe. All rights reserved.
      ...
      */
                    ...
                    var getStorageByType = function getStorageByType(
                      ...
                      return {
                        ...
                        getItem: function getItem(name) {
                          try {
                            return context[storageType].getItem(
                              namespace + name,
                            );
                          } catch (e) {
                            return null;
                    ...
                    var injectStorage = function injectStorage(context) {
                      return function (additionalNamespace) {
                        var finalNamespace =
                          baseNamespace + additionalNamespace;
                        return {
      ...
      */
                    ...
                    function v4(options, buf, offset) {
                      ...
                      options = options || {};
                      var rnds =
                        options.random || (options.rng || rngBrowser)(); // Per 4.4, set bits for version and `clock_seq_hi_and_reserved`
      ...
      */
                    ...
                    var chain = function chain(leftValidator, rightValidator) {
                      ...
                      var combinedValidator = function combinedValidator(
                        value,
                        path,
                      ) {
      ...
      */
                    ...
                    var nullSafeChain = function nullSafeChain(
                      leftValidator,
                      rightValidator,
                      additionalMethods,
                    ) {
                      var rightValidatorWithNullCheck =
                        function rightValidatorWithNullCheck(value, path) {
                          return value == null
                            ? value
                            : rightValidator(value, path);
                        };

                      return chain(
                        leftValidator,
                        rightValidatorWithNullCheck,
                        additionalMethods,
                      );
                    };
                    /*
      ...
      */
                    ...
                    var assertValid = function assertValid(
                      isValid,
                      value,
                      path,
                      message,
      ...
      */
                    ...
                    var booleanValidator = function booleanValidator(
                      value,
                      path,
                    ) {
                      assertValid(
      ...
      */
                    ...
                    var callbackValidator = function callbackValidator(
                      value,
                      path,
                    ) {
      ...
      */
                    ...
                    var createArrayOfValidator =
                      function createArrayOfValidator(elementValidator) {
      ...
      */
                    ...
                    var createLiteralValidator =
                      function createLiteralValidator(literalValue) {
                        return function (value, path) {
                          assertValid(
                            value === literalValue,
                            value,
      ...
      */
                    ...
                    var createMapOfValuesValidator =
                      function createMapOfValuesValidator(valueValidator) {
                        return function (value, path) {
                          assertValid(
                            isObject(value),
                            value,
                          ...
                          Object.keys(value).forEach(function (subKey) {
                            ...
                            try {
                              var validatedValue = valueValidator(
                                subValue,
                                subPath,
                              );
      ...
      */
                    ...
                    var createMinimumValidator =
                      function createMinimumValidator(typeName, minimum) {
                        return function (value, path) {
                          assertValid(
                            value >= minimum,
                            value,
      ...
      */
                    ...
                    var createNoUnknownFieldsValidator =
                      function createNoUnknownFieldsValidator(schema) {
                        return function (value, path) {
                          var errors = [];
                          Object.keys(value).forEach(function (subKey) {
                            if (!schema[subKey]) {
      ...
      */
                    ...
                    var createNonEmptyValidator =
                      function createNonEmptyValidator(message) {
                        return function (value, path) {
                          if (isObject(value)) {
                            assertValid(
                              !isEmptyObject(value),
      ...
      */
                    ...
                    var createObjectOfValidator =
                      function createObjectOfValidator(schema) {
                        return function (value, path) {
                          assertValid(
                            isObject(value),
                            value,
      ...
      */
                    ...
                    var createAnyOfValidator = function createAnyOfValidator(
                      validators,
                      message,
                    ) {
                      return function (value, path) {
      ...
      */
                    ...
                    var domainValidator = function domainValidator(
                      value,
                      path,
                    ) {
                      assertValid(
      ...
      */
                    ...
                    var regexpValidator = function regexpValidator(
                      value,
                      path,
                    ) {
                      assertValid(
      ...
      */
                    ...
                    var stringValidator = function stringValidator(
                      value,
                      path,
                    ) {
      ...
      */
                    ...
                    var minimumInteger = function minimumInteger(minValue) {
                      return nullSafeChain(
                        this,
                        createMinimumValidator("an integer", minValue),
                      );
                    };
                    ...
                    var minimumNumber = function minimumNumber(minValue) {
                      return nullSafeChain(
                        this,
                        createMinimumValidator("a number", minValue),
                      );
                    };
                    ...
                    var nonEmptyString = function nonEmptyString() {
                      return nullSafeChain(
                        this,
                        createNonEmptyValidator("a non-empty string"),
                      );
                    };
                    ...
                    var nonEmptyArray = function nonEmptyArray() {
                      return nullSafeChain(
                        this,
                        createNonEmptyValidator("a non-empty array"),
                      );
                    };
                    ...
                    var nonEmptyObject = function nonEmptyObject() {
                      return nullSafeChain(
                        this,
                        createNonEmptyValidator("a non-empty object"),
                      );
                    };
                    ...
                    var anyOf = function anyOf(validators, message) {
                      ...
                      return chain(
                        this,
                        createAnyOfValidator(validators, message),
                      );
                    };
                    ...
                    var arrayOf = function arrayOf(elementValidator) {
                      return nullSafeChain(
                        this,
                        createArrayOfValidator(elementValidator),
                        {
                    ...
                    var literal = function literal(literalValue) {
                      return nullSafeChain(
                        this,
                        createLiteralValidator(literalValue),
                      );
                    };
                    ...
                    var mapOfValues = function mapOfValues(valuesValidator) {
                      return nullSafeChain(
                        this,
                        createMapOfValuesValidator(valuesValidator),
                        {
                    ...
                    var objectOf = function objectOf(schema) {
                      var noUnknownFields = function noUnknownFields() {
                        return nullSafeChain(
                          this,
                          createNoUnknownFieldsValidator(schema),
                        );
                      };
      ...
      */
                    ...
                    var validateIdentityMap = boundMapOfValues(
                      boundArrayOf(
                        boundObjectOf({
                          authenticatedState: boundEnumOf(
                            AMBIGUOUS,
                            AUTHENTICATED,
                            LOGGED_OUT,
                          ),
      ...
      */
                    ...
                    var createLogController = function createLogController(
                      _ref,
                    ) {
                      ...
                      var parsedQueryString =
                        queryString__default["default"].parse(locationSearch);
                      ...
                      var debugEnabledWritableFromConfig =
                        debugSessionValue === null;

                      var getDebugEnabled = function getDebugEnabled() {
                        return debugEnabled;
                      };

                      var setDebugEnabled = function setDebugEnabled(
                        value,
                        _ref2,
                      ) {
                      ...
                      if (parsedQueryString[debugQueryParam] !== undefined) {
                        setDebugEnabled(
                          stringToBoolean(parsedQueryString[debugQueryParam]),
                          {
                            fromConfig: false,
                          },
                        );
      ...
      */
                    ...
                    var createLifecycle = function createLifecycle(
                      componentRegistry,
                    ) {
                      return hookNames.reduce(function (memo, hookName) {
                        memo[hookName] = guardHook(
                          createHook(componentRegistry, hookName),
                        );
                        return memo;
                      }, {});
                    };
      ...
      */
                    ...
                    var createComponentRegistry =
                      function createComponentRegistry() {
                        ...
                        var registerComponentCommands =
                          function registerComponentCommands(namespace) {
                            ...
                            Object.keys(componentCommandsByName).forEach(
                              function (commandName) {
                                var command =
                                  componentCommandsByName[commandName];
                        ...
                        var registerLifecycleCallbacks =
                          function registerLifecycleCallbacks(namespace) {
                        ...
                        return {
                          ...
                          getLifecycleCallbacks: function getLifecycleCallbacks(
                            hookName,
                          ) {
                    ...
                    var injectSendNetworkRequest =
                      function injectSendNetworkRequest(_ref) {
                        var logger = _ref.logger,
                          networkStrategy = _ref.networkStrategy,
                          isRetryableHttpStatusCode =
                            _ref.isRetryableHttpStatusCode;
                        /**
      ...
      */
                    ...
                    var createDeclinedConsentError =
                      function createDeclinedConsentError() {
                    ...
                    var createConsentStateMachine =
                      function createConsentStateMachine() {
                        var deferreds = [];
                        ...
                        var discardAll = function discardAll() {
                          while (deferreds.length) {
                            deferreds
                              .shift()
                              .reject(createDeclinedConsentError());
                          }
                        };
                      ...
                      return {
                        setConsent: function setConsent(consentByPurpose) {
                          switch (consentByPurpose[GENERAL]) {
                            ...
                            case OUT:
                              logger.warn(
                                "Some commands may fail. " + DECLINED_CONSENT,
                              );
      ...
      */
                    ...
                    var createEvent = function createEvent() {
                      ...
                      var event = {
                        ...
                        setLastChanceCallback: function setLastChanceCallback(
                          value,
                        ) {
      ...
      */
                    ...
                    var createResponse = function createResponse() {
                      ...
                      var _content$handle = content.handle,
                        handle =
                          _content$handle === void 0 ? [] : _content$handle,
                        _content$errors = content.errors,
                        errors =
                          _content$errors === void 0 ? [] : _content$errors,
                        _content$warnings = content.warnings,
                        warnings =
                          _content$warnings === void 0 ? [] : _content$warnings;
                      /**
                       * Response object.
      ...
      */
                    ...
                    var injectExecuteCommand = function injectExecuteCommand(
                      _ref,
                    ) {
                      var logger = _ref.logger,
                            ...
                            executor = function executor() {
                              return configurePromise.then(
                                function (componentRegistry) {
                                  var command =
                                    componentRegistry.getCommand(commandName);

                                  if (!command || !isFunction(command.run)) {
                                    var commandNames = values(coreCommands)
                                      .concat(
      ...
      */
                    ...
                    var validateCommandOptions =
                      function validateCommandOptions(_ref) {
      ...
      */
                    ...
                    var validateUserEventOptions =
                      function validateUserEventOptions(_ref) {
                          ...
                          sendEvent: {
                            ...
                            run: function run(options) {
                              var xdm = options.xdm,
                                ...
                                decisionScopes =
                                  _options$decisionScop === void 0
                                    ? []
                                    : _options$decisionScop,
      ...
      */
                    ...
                    var attachClickActivityCollector =
                      function attachClickActivityCollector(_ref2) {
      ...
      */
                    ...
                    var urlStartsWithScheme = function urlStartsWithScheme(
                      url,
                    ) {
                    ...
                    var getAbsoluteUrlFromAnchorElement =
                      function getAbsoluteUrlFromAnchorElement(
                        window,
                        element,
                      ) {
                    ...
                    var isSupportedAnchorElement =
                      function isSupportedAnchorElement(element) {
                        if (
                          element.href &&
                          (element.tagName === "A" ||
                    ...
                    var isDownloadLink = function isDownloadLink(
                      ...
                      return clickedObj.download
                        ? true
                        : re.test(linkUrl.toLowerCase());
                    };
      ...
      */
                    ...
                    var findSupportedAnchorElement =
                      function findSupportedAnchorElement(targetElement) {
                    ...
                    var createLinkClick = function createLinkClick(
                      window,
                      config,
                    ) {
                      return function (event, targetElement) {
                        ...
                        var anchorElement =
                          findSupportedAnchorElement(targetElement);

                        if (!anchorElement) {
                          return;
                        }

                        var linkUrl = getAbsoluteUrlFromAnchorElement(
                          window,
                          anchorElement,
                        );
                        ...
                        var linkType = determineLinkType(
                          window,
                          config,
                          linkUrl,
                          anchorElement,
      ...
      */
                    ...
                    var createActivityCollector =
                      function createActivityCollector(_ref) {
                        ...
                        return {
                          lifecycle: {
                            onComponentsRegistered:
                              function onComponentsRegistered(tools) {
      ...
      */
                    ...
                    var createResultLogMessage =
                      function createResultLogMessage(idSync, success) {
                        return (
                          "ID sync " +
                    ...
                    var injectProcessIdSyncs = function injectProcessIdSyncs(
                      _ref,
                    ) {
                      var fireReferrerHideableImage =
                          _ref.fireReferrerHideableImage,
                        logger = _ref.logger;
                        ...
                        return Promise.all(
                          urlIdSyncs.map(function (idSync) {
                            return fireReferrerHideableImage(idSync.spec)
                              .then(function () {
                                logger.log(
                                  createResultLogMessage(idSync, true),
                                );
                              })
                              ["catch"](function () {
                                ...
                                logger.error(
                                  createResultLogMessage(idSync, false),
                                );
                              });
                          }),
                        ).then(noop);
      ...
      */
                    ...
                    configValidators$1.reactorRegisterGetEcid = boundCallback()[
                      "default"
                    ](function () {});
                    /*
      Copyright 2020 Adobe. All rights reserved.
      ...
      */
                    ...
                    var getIdentityOptionsValidator =
                      function getIdentityOptionsValidator(options) {
                        var getIdentityOptionsValidator = boundObjectOf({
                          namespaces: boundArrayOf(
                            boundLiteral("ECID"),
                          ).nonEmpty(),
                        }).noUnknownFields();
                            ...
                            run: function run(options) {
                              return consent
                                ...
                                .then(function () {
                                  return ecid
                                    ? undefined
                                    : getIdentity(options.namespaces);
                                })
                                .then(function () {
                                  return {
                                    identity: {
      ...
      */
                    ...
                    var apexDomain = getApexDomain(
                      window,
                      cookie__default["default"],
                    );
                    /**
                     * Handles migration of ECID to and from Visitor.js.
                     */

                    var createLegacyIdentity = function createLegacyIdentity(
                      _ref,
                    ) {
                      var config = _ref.config,
                      ...
                      var getEcidFromLegacyCookies =
                        function getEcidFromLegacyCookies() {
                          var ecid = null;
                          var secidCookieName = "s_ecid";
                          var legacyEcidCookieValue =
                            cookie__default["default"].get(secidCookieName) ||
                            cookie__default["default"].get(amcvCookieName);
      ...
      */
                    ...
                    var awaitVisitorOptIn = function awaitVisitorOptIn(_ref) {
                      ...
                      return new Promise(function (resolve, reject) {
                        if (
                          isObject(window.adobe) &&
                          isObject(window.adobe.optIn)
                        ) {
                          ...
                          optInOld.fetchPermissions(function () {
                            if (
                              optInOld.isApproved([optInOld.Categories.ECID])
                            ) {
                              logger.log(
      ...
      */
                    ...
                    var getVisitor = function getVisitor(window) {
                      ...
                      return (
                        isFunction(Visitor) &&
                        isFunction(Visitor.getInstance) &&
                        Visitor
                      );
                    };
                    /*
      ...
      */
                    ...
                    var injectGetEcidFromVisitor =
                      function injectGetEcidFromVisitor(_ref) {
                        var logger = _ref.logger,
                          orgId = _ref.orgId,
      ...
      */
                    ...
                    var injectHandleResponseForIdSyncs =
                      function injectHandleResponseForIdSyncs(_ref) {
      ...
      */
                    ...
                    var injectEnsureSingleIdentity =
                      function injectEnsureSingleIdentity(_ref) {
                        var doesIdentityCookieExist =
                            _ref.doesIdentityCookieExist,
                        ...
                        var allowRequestToGoWithoutIdentity =
                          function allowRequestToGoWithoutIdentity(payload) {
                        ...
                        return function (_ref2) {
                          ...
                          if (obtainedIdentityPromise) {
                            ...
                            var previousObtainedIdentityPromise =
                              obtainedIdentityPromise; // This promise resolves when we have an identity cookie. Additional
                            // requests are chained together so that only one is sent at a time
                            // until we have the identity cookie.

                            obtainedIdentityPromise =
                              previousObtainedIdentityPromise["catch"](
                                function () {
      ...
      */
                    ...
                    var addEcidQueryToPayload = function addEcidQueryToPayload(
                      payload,
                    ) {
                      payload.mergeQuery({
                        identity: {
      ...
      */
                    ...
                    var injectDoesIdentityCookieExist =
                      function injectDoesIdentityCookieExist(_ref) {
                        ...
                        return function () {
                          return Boolean(
                            cookie__default["default"].get(identityCookieName),
                          );
                        };
                      };
      ...
      */
                    ...
                    var injectSetDomainForInitialIdentityPayload =
                      function injectSetDomainForInitialIdentityPayload(_ref) {
                        var thirdPartyCookiesEnabled =
                            _ref.thirdPartyCookiesEnabled,
      ...
      */
                    ...
                    var injectAddLegacyEcidToPayload =
                      function injectAddLegacyEcidToPayload(_ref) {
      ...
      */
                    ...
                    var addEcidToPayload = function addEcidToPayload(
                      payload,
                      ecid,
                    ) {
      ...
      */
                    ...
                    var injectAwaitIdentityCookie =
                      function injectAwaitIdentityCookie(_ref) {
                        var orgId = _ref.orgId,
      ...
      */
                    ...
                    var getEcidFromResponse = function getEcidFromResponse(
                      response,
                    ) {
                      var identityResultPayloads =
                        response.getPayloadsByType("identity:result");
                      var ecidPayload = find(
      ...
      */
                    ...
                    var createRequestPayload = function createRequestPayload(
                      construct,
                    ) {
                      var content = {};
                      var _useIdThirdPartyDomain = false;
                      var basePayload = {
                        mergeConfigOverrides: createMerger(
                          content,
                        ...
                        useIdThirdPartyDomain:
                          function useIdThirdPartyDomain() {
                            _useIdThirdPartyDomain = true;
                          },
                        getUseIdThirdPartyDomain:
                          function getUseIdThirdPartyDomain() {
      ...
      */
                    ...
                    var createAddIdentity = function createAddIdentity(
                      content,
                    ) {
      ...
      */
                    ...
                    var createIdentityPayload = function createIdentityPayload(
                      namespaces,
                    ) {
      ...
      */
                    ...
                    var createIdentity = function createIdentity(_ref) {
                      ...
                      var handleResponseForIdSyncs =
                        injectHandleResponseForIdSyncs({
      ...
      */
                    ...
                    var createResultLogMessage$1 =
                      function createResultLogMessage(urlDestination, success) {
                        return (
                          "URL destination " +
                          (success ? "succeeded" : "failed") +
                          ": " +
                      ...
                      return Promise.all(
                        urlDestinations.map(function (urlDestination) {
                          return fireReferrerHideableImage(urlDestination.spec)
                            .then(function () {
                              logger.log(
                                createResultLogMessage$1(urlDestination, true),
                              );
                            })
                            ["catch"](function () {
                              ...
                              // reject the promise handed back to the customer.
                              logger.error(
                                createResultLogMessage$1(urlDestination, false),
                              );
                            });
                        }),
                      ).then(noop);
                    ...
                    var processCookies = function processCookies(destinations) {
                      var cookieDestinations = destinations.filter(
                        function (dest) {
                    ...
                    var injectProcessDestinations =
                      function injectProcessDestinations(_ref) {
                        var fireReferrerHideableImage =
                            _ref.fireReferrerHideableImage,
                          logger = _ref.logger;
      ...
      */
                    ...
                    var createAudiences = function createAudiences(_ref) {
                      ...
                      var processDestinationsFromResponse =
                        function processDestinationsFromResponse(_ref2) {
      ...
      */
                    ...
                    var createPersonalizationDetails =
                      function createPersonalizationDetails(_ref) {
                        ...
                        return {
                          ...
                          createQueryDetails: function createQueryDetails() {
                            ...
                            if (
                              ...
                              !includes(scopes, PAGE_WIDE_SCOPE)
                            ) {
                          ...
                          shouldFetchData: function shouldFetchData() {
                            return (
                              this.hasScopes() || !this.isCacheInitialized()
                            );
                          },
                          shouldUseCachedData: function shouldUseCachedData() {
                            return (
                              this.hasViewName() && this.isCacheInitialized()
                            );
                          },
                        };
                      };
                        ...
                        lifecycle: {
                          onBeforeEvent: function onBeforeEvent(_ref2) {
                            var event = _ref2.event,
                              ...
                              decisionScopes =
                                _ref2$decisionScopes === void 0
                                  ? []
                                  : _ref2$decisionScopes,
                              _ref2$onResponse = _ref2.onResponse,
                              onResponse =
                                _ref2$onResponse === void 0
                                  ? noop
                                  : _ref2$onResponse,
                              _ref2$onRequestFailur = _ref2.onRequestFailure,
                              onRequestFailure =
                                _ref2$onRequestFailur === void 0
                                  ? noop
                                  : _ref2$onRequestFailur;
      ...
      */
                    ...
                    var css_escape = createCommonjsModule(
                            ...
                            var cssEscape = function cssEscape(value) {
                              ...
                              while (++index < length) {
                                ...
                                if (
                                  ...
                                  (index == 0 &&
                                    codeUnit >= 0x0030 &&
                                    codeUnit <= 0x0039) || // If the character is the second character and is in the range [0-9]
      ...
      */
                    ...
                    var replaceIdentifier = function replaceIdentifier(
                      _,
                      $1,
                      $2,
                    ) {
                    ...
                    var escapeIdentifiersInSelector =
                      function escapeIdentifiersInSelector(selector) {
                        return selector.replace(
                          CSS_IDENTIFIER_PATTERN,
                          replaceIdentifier,
                        );
                      };
                    ...
                    var parseSelector = function parseSelector(rawSelector) {
                      var result = [];
                      var selector = escapeIdentifiersInSelector(
                        rawSelector.trim(),
                      );
                    ...
                    var selectNodesWithEq = function selectNodesWithEq(
                      selector,
                    ) {
                      var doc = document;
      ...
      */
                    ...
                    var hideElements = function hideElements(
                      ...
                      var props = {
                        textContent:
                          prehidingSelector + " " + HIDING_STYLE_DEFINITION,
                      };
      ...
      */
                    ...
                    var isInlineStyleElement = function isInlineStyleElement(
                      element,
                    ) {
                      return is(element, STYLE) && !getAttribute(element, SRC);
                    };

                    var addNonceToInlineStyleElements =
                      function addNonceToInlineStyleElements(fragment) {
                    ...
                    var isInlineScript = function isInlineScript(element) {
                      return (
                        is$1(element, SCRIPT) && !getAttribute(element, SRC)
                      );
                    };
                    ...
                    var getRemoteScriptsUrls = function getRemoteScriptsUrls(
                      fragment,
                    ) {
                      var scripts = selectNodes(SCRIPT, fragment);
                      var result = [];
                    ...
                    var executeRemoteScripts = function executeRemoteScripts(
                      urls,
                    ) {
                      return Promise.all(
                        urls.map(loadScript__default["default"]),
                      );
                    };
                    /*
      Copyright 2019 Adobe. All rights reserved.
      ...
      */
                    ...
                    var insertHtmlBefore = function insertHtmlBefore(
                      container,
                      html,
                    ) {
                      var fragment = createFragment(html);
      ...
      */
                    ...
                    var insertHtmlAfter = function insertHtmlAfter(
                      container,
                      html,
                    ) {
                      var fragment = createFragment(html);
      ...
      */
                    ...
                    var rearrangeChildren = function rearrangeChildren(
                      container,
                      _ref,
                    ) {
                      var from = _ref.from,
      ...
      */
                    ...
                    var logActionError = function logActionError(
                      logger,
                      action,
                      error,
                    ) {
                    ...
                    var logActionCompleted = function logActionCompleted(
                      logger,
                      action,
                    ) {
                      if (logger.enabled) {
                    ...
                    var createViewCollect = function createViewCollect(_ref) {
                      ...
                      return function (_ref2) {
                        ...
                        var _meta$decisions = meta.decisions,
                          decisions =
                            _meta$decisions === void 0 ? [] : _meta$decisions;
                        var data = {
                          eventType: "display",
                        };
                        var event = eventManager.createEvent();
      ...
      */
                    ...
                    var createExecuteDecisions =
                      function createExecuteDecisions(_ref) {
                        var modules = _ref.modules,
                          logger = _ref.logger,
                          executeActions = _ref.executeActions,
                          collect = _ref.collect;
                        return function (decisions) {
                          var actionResultsPromises = decisions.map(
                            function (decision) {
      ...
      */
                    ...
                    var createFetchDataHandler =
                      function createFetchDataHandler(_ref) {
                        var config = _ref.config,
                        ...
                        return function (_ref2) {
                          ...
                          mergeQuery(
                            event,
                            personalizationDetails.createQueryDetails(),
                          );
      ...
      */
                    ...
                    var matchesSelectorWithEq = function matchesSelectorWithEq(
                      selector,
                      element,
                    ) {
                      if (isNotEqSelector(selector)) {
      ...
      */
                    ...
                    var getMetaIfMatches = function getMetaIfMatches(
                      clickedElement,
                      value,
                    ) {
                    ...
                    var collectClicks = function collectClicks(
                      clickedElement,
                      values,
                    ) {
                      if (values.length === 0) {
      ...
      */
                    ...
                    var isAuthoringModeEnabled =
                      function isAuthoringModeEnabled() {
                        var doc =
                          arguments.length > 0 && arguments[0] !== undefined
                            ? arguments[0]
                            : document;
      ...
      */
                    ...
                    var createOnClickHandler = function createOnClickHandler(
                      _ref,
                    ) {
      ...
      */
                    ...
                    var createExecuteCachedViewDecisions =
                      function createExecuteCachedViewDecisions(_ref) {
      ...
      */
                    ...
                    var createViewCacheManager =
                      function createViewCacheManager() {
                        var viewStorage;
      ...
      */
                    ...
                    var createViewChangeHandler =
                      function createViewChangeHandler(_ref) {
                        var executeCachedViewDecisions =
                            _ref.executeCachedViewDecisions,
                          viewCache = _ref.viewCache,
                          showContainers = _ref.showContainers;
                        return function (_ref2) {
                          var personalizationDetails =
                    ...
                    var createDecision = function createDecision(
                      decision,
                      items,
                    ) {
                      return {
                    ...
                    var splitDecisions = function splitDecisions(
                      decisions,
                      schema,
                    ) {
                      ...
                      decisions.forEach(function (decision) {
                        var _decision$items = decision.items,
                          items =
                            _decision$items === void 0 ? [] : _decision$items;
                        ...
                        if (isNonEmptyArray(matchedItems)) {
                          domActionDecisions.push(
                            createDecision(decision, matchedItems),
                          );
                        }

                        if (isNonEmptyArray(nonMatchedItems)) {
                          nonDomActionDecisions.push(
                            createDecision(decision, nonMatchedItems),
                          );
                        }
                      });
                      return {
                    ...
                    var extractDecisionsByScope =
                      function extractDecisionsByScope(decisions, scope) {
                        ...
                        if (isNonEmptyArray(decisions)) {
                          decisions.forEach(function (decision) {
                            if (decision.scope === scope) {
                              ...
                              nonPageWideScopeDecisions[decision.scope].push(
                                decision,
                              );
                            }
                          });
                    ...
                    var decisionsExtractor = {
                      groupDecisionsBySchema: function groupDecisionsBySchema(
                        _ref,
                      ) {
                      ...
                      groupDecisionsByScope: function groupDecisionsByScope(
                        _ref2,
                      ) {
                    ...
                    var createOnResponseHandler =
                      function createOnResponseHandler(_ref) {
                        ...
                        return function (_ref2) {
                          ...
                          var _decisionsExtractor$g =
                              decisionsExtractor.groupDecisionsBySchema({
                                decisions: unprocessedDecisions,
                                schema: DOM_ACTION,
                              }),
                            domActionDecisions =
                              _decisionsExtractor$g.domActionDecisions,
                            nonDomActionDecisions =
                              _decisionsExtractor$g.nonDomActionDecisions;

                          var _decisionsExtractor$g2 =
                              decisionsExtractor.groupDecisionsByScope({
                                decisions: domActionDecisions,
                                scope: PAGE_WIDE_SCOPE,
                              }),
                            pageWideScopeDecisions =
                              _decisionsExtractor$g2.pageWideScopeDecisions,
                            nonPageWideScopeDecisions =
                              _decisionsExtractor$g2.nonPageWideScopeDecisions;
                          ...
                          var decisionsToBeReturned = [].concat(
                            _toConsumableArray(pageWideScopeDecisions),
                            _toConsumableArray(nonDomActionDecisions),
                          );

                          if (viewName && nonPageWideScopeDecisions[viewName]) {
                            decisionsToBeReturned.push.apply(
                              decisionsToBeReturned,
                              _toConsumableArray(
                                nonPageWideScopeDecisions[viewName],
                              ),
                            );
                          }
      ...
      */
                    ...
                    var createPersonalization = function createPersonalization(
                      _ref,
                    ) {
                      var config = _ref.config,
                        logger = _ref.logger,
                      ...
                      var executeCachedViewDecisions =
                        createExecuteCachedViewDecisions({
                          viewCache: viewCache,
      ...
      */
                    ...
                    var injectPlaceContext = function injectPlaceContext(
                      dateProvider,
                    ) {
                      return function (xdm) {
      ...
      */
                    ...
                    var injectTimestamp = function injectTimestamp(
                      dateProvider,
                    ) {
                      return function (xdm) {
      ...
      */
                    ...
                    var injectImplementationDetails =
                      function injectImplementationDetails(
                    ...
                    var createComponent$3 = function createComponent$3(_ref) {
                      var readStoredConsent = _ref.readStoredConsent,
                        ...
                        validateSetConsentOptions =
                          _ref.validateSetConsentOptions;
                      var consentByPurpose = assign__default["default"](
                        _defineProperty({}, GENERAL, defaultConsent),
                        readStoredConsent(),
                      );
                      consent.setConsent(consentByPurpose);

                      var readCookieIfQueueEmpty =
                        function readCookieIfQueueEmpty() {
      ...
      */
                    ...
                    var createConsentRequestPayload =
                      function createConsentRequestPayload() {
                        return createRequestPayload(function (content) {
                          return {
                            addIdentity: function addIdentity(
                              namespaceCode,
      ...
      */
                    ...
                    var injectReadStoredConsent =
                      function injectReadStoredConsent(_ref) {
                        var parseConsentCookie = _ref.parseConsentCookie,
                          orgId = _ref.orgId,
                          cookieJar = _ref.cookieJar;
                        var consentCookieName = getNamespacedCookieName(
                          orgId,
                          CONSENT,
                        );
                        return function () {
      ...
      */
                    ...
                    var injectSendSetConsentRequest =
                      function injectSendSetConsentRequest(_ref) {
                        var createConsentRequestPayload =
                            _ref.createConsentRequestPayload,
                          sendEdgeNetworkRequest = _ref.sendEdgeNetworkRequest;
                        return function (_ref2) {
      ...
      */
                    ...
                    var parseConsentCookie = function parseConsentCookie(
                      cookieValue,
                    ) {
                      var categoryPairs = cookieValue.split(";");
                      return categoryPairs.reduce(function (
                        consentByPurpose,
                        categoryPair,
                      ) {
                        var _categoryPair$split = categoryPair.split("="),
                          _categoryPair$split2 = _slicedToArray(
                            _categoryPair$split,
                            2,
                          ),
                    ...
                    var validateSetConsentOptions = boundObjectOf({
                      consent: boundArrayOf(boundAnything())
                        .required()
                        .nonEmpty(),
                      identityMap: validateIdentityMap,
                    })
      ...
      */
                    ...
                    var generateEventMergeIdResult =
                      function generateEventMergeIdResult() {
                        return {
                          eventMergeId: v4_1(),
                        };
                      };
                    ...
                    var createEventMerge = function createEventMerge(_ref) {
                      ...
                      config.reactorRegisterCreateEventMergeId(
                        generateEventMergeIdResult,
                      );
                      return {
                        commands: {
                          createEventMergeId: {
                    ...
                    createEventMerge.configValidators.reactorRegisterCreateEventMergeId =
                      boundCallback()["default"](function () {});
                    /*
      Copyright 2019 Adobe. All rights reserved.
      This file is licensed to you under the Apache License, Version 2.0 (the "License");
      you may not use this file except in compliance with the License. You may obtain a copy
      ...
      */
                    ...
                    var transformOptions = function transformOptions(
                      ...
                      try {
                        var validator = boundObjectOf(schema)
                          .noUnknownFields()
                          .required();
                    ...
                    var buildAndValidateConfig =
                      function buildAndValidateConfig(_ref) {
                        var options = _ref.options,
                        ...
                        var config = createConfig(
                          transformOptions(schema, options),
                        );
                    ...
                    var initializeComponents = function initializeComponents(
                      ...
                      var componentCreators = _ref.componentCreators,
                        ...
                        getImmediatelyAvailableTools =
                          _ref.getImmediatelyAvailableTools;
                      componentCreators.forEach(function (createComponent) {
                      ...
                      return function (error, operation) {
                        ...
                        if (err.code === DECLINED_CONSENT_ERROR_CODE) {
                          logger.warn(
                            "The " +
                              operation +
                              " could not fully complete because the user declined consent.",
                          );
                          return {};
                        }
      ...
      */
                    ...
                    var injectSendXhrRequest = function injectSendXhrRequest(
                      XMLHttpRequest,
                    ) {
      ...
      */
                    ...
                    var injectSendBeacon = function injectSendBeacon(
                      navigator,
                      fetch,
                      logger,
                    ) {
                      return function (url, body) {
                        ...
                        if (!navigator.sendBeacon(url, blob)) {
                          logger.log(
                            "The `beacon` call has failed; falling back to `fetch`",
                          );
      ...
      */
                    ...
                    var injectNetworkStrategy = function injectNetworkStrategy(
                      _ref,
                    ) {
      ...
      */
                    ...
                    var createLogger = function createLogger(_ref) {
                      ...
                      var notifyMonitors = function notifyMonitors(
                        method,
                        data,
                      ) {
                        ...
                        if (monitors.length > 0) {
                          var dataWithContext = assign__default["default"](
                            {},
                            context,
                            data,
                          );
                      ...
                      return {
                        ...
                        logOnInstanceCreated: function logOnInstanceCreated(
                          data,
                        ) {
                          notifyMonitors("onInstanceCreated", data);
                          log("info", "Instance initialized.");
                        },
                        logOnInstanceConfigured:
                          function logOnInstanceConfigured(data) {
                        ...
                        logOnBeforeNetworkRequest:
                          function logOnBeforeNetworkRequest(data) {
                        ...
                        logOnNetworkResponse: function logOnNetworkResponse(
                          data,
                        ) {
      ...
      */
                    ...
                    var createEventManager = function createEventManager(_ref) {
                      ...
                      var onBeforeEventSendWithLoggedExceptions =
                        function onBeforeEventSendWithLoggedExceptions() {
                          try {
                        ...
                        sendEvent: function sendEvent(event) {
                          var options =
                            arguments.length > 1 && arguments[1] !== undefined
                              ? arguments[1]
                              : {};
                          event.setLastChanceCallback(
                            onBeforeEventSendWithLoggedExceptions,
                          );
                          ...
                          var onRequestFailureCallbackAggregator =
                            createCallbackAggregator();
                          return lifecycle
                            .onBeforeEvent({
                              event: event,
                            ...
                            .then(function () {
                              var documentMayUnload =
                                event.getDocumentMayUnload();
                              var action = documentMayUnload
                                ? "collect"
                                : "interact";
                              return sendEdgeNetworkRequest({
                                payload: payload,
      ...
      */
                    ...
                    var createCookieTransfer = function createCookieTransfer(
                      _ref,
                    ) {
                      ...
                      return {
                         ...
                         */
                        cookiesToPayload: function cookiesToPayload(
                          payload,
                          endpointDomain,
                        ) {
                          var isEndpointFirstParty = endsWith(
                            endpointDomain,
                            apexDomain,
                          );
                          var state = {
                         ...
                         */
                        responseToCookies: function responseToCookies(
                          response,
                        ) {
                          response
      ...
      */
                    ...
                    var createDataCollectionRequestPayload =
                      function createDataCollectionRequestPayload() {
                        return createRequestPayload(function (content) {
                          return {
                            addIdentity: createAddIdentity(content),
                            ...
                            getDocumentMayUnload:
                              function getDocumentMayUnload() {
                                return (content.events || []).some(
                                  function (event) {
                    ...
                    var injectSendEdgeNetworkRequest =
                      function injectSendEdgeNetworkRequest(_ref) {
                        var config = _ref.config,
                          lifecycle = _ref.lifecycle,
                          ...
                          processWarningsAndErrors =
                            _ref.processWarningsAndErrors,
                          validateNetworkResponseIsWellFormed =
                            _ref.validateNetworkResponseIsWellFormed;
                        ...
                        return function (_ref2) {
                          var payload = _ref2.payload,
                            action = _ref2.action,
                            _ref2$runOnResponseCa =
                              _ref2.runOnResponseCallbacks,
                            runOnResponseCallbacks =
                              _ref2$runOnResponseCa === void 0
                                ? noop
                                : _ref2$runOnResponseCa,
                            _ref2$runOnRequestFai =
                              _ref2.runOnRequestFailureCallbacks,
                            runOnRequestFailureCallbacks =
                              _ref2$runOnRequestFai === void 0
                                ? noop
                                : _ref2$runOnRequestFai;
                          var onResponseCallbackAggregator =
                            createCallbackAggregator();
                          onResponseCallbackAggregator.add(
                          ...
                          return lifecycle
                            ...
                            .then(function () {
                              var endpointDomain =
                                payload.getUseIdThirdPartyDomain()
                                  ? ID_THIRD_PARTY
                                  : edgeDomain;
                              var requestId = v4_1();
                              var url =
                            ...
                            .then(function (_ref3) {
                              ...
                              return onResponseCallbackAggregator
                                ...
                                .then(function (returnValues) {
                                  ...
                                  var lifecycleOnResponseReturnValues =
                                    returnValues.shift() || [];
                                  var consumerOnResponseReturnValues =
                                    returnValues.shift() || [];
                                  var lifecycleOnBeforeRequestReturnValues =
                                    returnValues;
                                  return assign__default["default"].apply(
                                    void 0,
                                    [{}].concat(
                                      _toConsumableArray(
      ...
      */
                    ...
                    var injectProcessWarningsAndErrors =
                      function injectProcessWarningsAndErrors(_ref) {
                        var logger = _ref.logger;
                        /**
                        ...
                        return function (response) {
                          ...
                          if (errors.length) {
                            var errorMessage = errors.reduce(function (
                              memo,
                              error,
                            ) {
                              return (
      ...
      */
                    ...
                    var validateNetworkResponseIsWellFormed =
                      function validateNetworkResponseIsWellFormed(
                        networkResponse,
                      ) {
                        ...
                        if (
                          ...
                          var messageSuffix = body
                            ? "response body: " + body
                            : "no response body.";
                          throw new Error(
                            "Unexpected server response with status code " +
                              statusCode +
                              " and " +
                              messageSuffix,
                          );
      ...
      */
                    ...
                    var apexDomain$1 = getApexDomain(
                      window,
                      cookie__default["default"],
                    );
                    ...
                    if (instanceNames) {
                      instanceNames.forEach(function (instanceName) {
                        var _createLogController = createLogController({
                          ...
                          setDebugEnabled =
                            _createLogController.setDebugEnabled,
                          logger = _createLogController.logger,
                          createComponentLogger =
                            _createLogController.createComponentLogger;
                        ...
                        var setDebugCommand = function setDebugCommand(
                          options,
                        ) {
                        ...
                        var configureCommand = function configureCommand(
                          options,
                        ) {
                          ...
                          var processWarningsAndErrors =
                            injectProcessWarningsAndErrors({
                              logger: logger,
                            });
                          var sendEdgeNetworkRequest =
                            injectSendEdgeNetworkRequest({
                              config: config,
                              lifecycle: lifecycle,
                          ...
                          return initializeComponents({
                            ...
                            getImmediatelyAvailableTools:
                              function getImmediatelyAvailableTools(
                                componentName,
                              ) {
                                var componentLogger =
...
*/
              module.exports = function (_ref) {
                ...
                var instanceNames = instancesSettings.map(
                  ...
                  instance(
                    ...
                    _objectSpread({}, options, {
                      ...
                      reactorRegisterCreateEventMergeId:
                        function reactorRegisterCreateEventMergeId(
                          _createEventMergeId,
                        ) {
          ...
          instances: [
            {
              ...
              developmentEdgeConfigId:
                "2c7ea11d-7a81-47db-b0d7-745890d68e67:dev",
            },
          ],
        },
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/07c2a9012ef3/6232856ef9ff/hostedLibFiles/EP4426249d34fd41a594efc0decc99e6cb/",
      },
    },
    company: {
...
var _satellite = (function () {
    ...
    return function (action, rule, syntheticEvent, lastPromiseInQueue) {
      return lastPromiseInQueue.then(function () {
        ...
        return new reactorPromise(function (resolve, reject) {
          ...
          reactorPromise
            .race([moduleResult, timeoutPromise])
            .then(resolve, reject);
        })
          .catch(function (e) {
  ...
  */
  ...
  var createGetSyntheticEventMeta = function (moduleProvider) {
    return function (ruleEventPair) {
      ...
      var moduleName = moduleProvider.getModuleDefinition(
        event.modulePath,
      ).name;
      var extensionName = moduleProvider.getModuleExtensionName(
        event.modulePath,
      );
  ...
  */
  ...
  var createLogActionError = function (
    ...
    return function (action, rule, e) {
      ...
      logger.error(
        getRuleComponentErrorMessage(actionDisplayName, rule.name, e),
      );
  ...
  */
  ...
  var getRuleComponentErrorMessage = function (
    ruleComponentName,
    ruleName,
    error,
  ) {
  ...
  */
  ...
  var hydrateSatelliteObject = function (
    ...
    var customScriptPrefixedLogger =
      logger.createPrefixedLogger("Custom Script");
