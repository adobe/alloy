...
document.documentMode && document.documentMode < 11
  ...
  : (function () {
      ...
      var d = (function () {
          ...
          ? Object.assign
          : function (e, n) {
              for (var t, r, o = f(e), i = 1; i < arguments.length; i++) {
                for (var a in (t = Object(arguments[i])))
                  u.call(t, a) && (o[a] = t[a]);
                if (c) {
                  r = c(t);
                  for (var d = 0; d < r.length; d++)
                    s.call(t, r[d]) && (o[r[d]] = t[r[d]]);
                }
              }
              return o;
            },
      ...
      var v = p(function (e, n) {
              ...
              function r(n, o, i) {
                ...
                if ("undefined" != typeof document) {
                  ...
                  for (
                    ...
                    try {
                      var v = g[0].replace(d, decodeURIComponent);
                      if (
                        ((p = t.read
                          ? t.read(p, v)
                          : t(p, v) || p.replace(d, decodeURIComponent)),
                        this.json)
                      )
                        try {
                          p = JSON.parse(p);
        ...
        m = { get: v.get, set: v.set, remove: v.remove },
        h = function (e) {
          return null == e;
        };
      function y(e) {
      ...
      var O = function (e) {
          return !h(e) && !Array.isArray(e) && "object" === y(e);
        },
        R = function e(n, t) {
          Object.keys(t).forEach(function (r) {
            O(n[r]) && O(t[r]) ? e(n[r], t[r]) : (n[r] = t[r]);
          });
        },
        S = function (e) {
          if (h(e))
        ...
        B = function (e) {
          ...
          return new Promise(function (e, t) {
            M(A, { src: n }, { onload: e, onerror: t, onabort: t }, [], r);
          });
        },
        _ = function (e) {
        ...
        $ = function (e, n, t, r) {
          return Q(function (o, i) {
            !(function t() {
              var i = r(n);
              V(i) ? o(i) : e.requestAnimationFrame(t);
            })(),
              setTimeout(function () {
                i(J(n));
              }, t);
            ...
            ? ((n = { src: r }.src),
              Y("BODY")
                ...
                .then(function (e) {
                  ...
                  return B({ src: n, currentDocument: t }).then(function () {
                    Z(e);
                  });
                }))
            : ee({ src: r });
        ...
        ce = function (e, n) {
          for (
            ...
            (o = ((t = i), (r = a += 1), t.slice(-r)).join(".")),
              n.set(ae, ae, { domain: o });
          return n.remove(ae, { domain: o }), o;
        },
        ue = function (e) {
          return e.replace("@", "_");
        },
      ...
      for (
        var ye = function (e, n, t, r) {
          ...
          be = function (e, n, t, r) {
            return (
              ...
              "object" == typeof e
                ? Object.keys(e)
                    .map(function (r) {
                      var o = encodeURIComponent(we(r)) + t;
                      return Array.isArray(e[r])
                        ? e[r]
                            .map(function (e) {
                              return o + encodeURIComponent(we(e));
                            })
                            .join(n)
                        : o + encodeURIComponent(we(e[r]));
                    })
                    .join(n)
                : r
                  ? encodeURIComponent(we(r)) + t + encodeURIComponent(we(e))
                  : ""
            );
          },
          Ce = p(function (e, n) {
            (n.decode = n.parse = ye), (n.encode = n.stringify = be);
          }),
          Ee =
            (Ce.decode,
            Ce.parse,
          ...
          Se = function (e) {
            ...
            return (
              ...
              c +
              (u > 0 ? "-" : "+") +
              me(Math.floor(Math.abs(u) / 60), 2, "0") +
              ":" +
              me(Math.abs(u) % 60, 2, "0")
            );
          },
          De = p(function (e) {
            var n =
        ...
        xe[Pe] = (Pe + 256).toString(16).substr(1);
      var qe = function (e, n) {
        var t = n || 0,
          r = xe;
        return [
      ...
      var je = function (e, n, t) {
        ...
        Fe = function (e, n) {
          return Ae(_(e), e, n, "a function"), e;
        },
        Ue = function (e, n) {
          return function (t, r) {
            return Ae(t >= n, t, r, e + " greater than or equal to " + n), t;
          };
        },
        Be = function (e) {
          return function (n, t) {
            return O(n) ? Ae(!de(n), n, t, e) : Ae(n.length > 0, n, t, e), n;
          };
        },
        _e = /^[a-z0-9.-]{1,}$/i,
        Ve = function (e, n) {
          return Ae(_e.test(e), e, n, "a valid domain"), e;
        },
        Le = function (e, n) {
          return (
            Ae(
        ...
        Qe = function (e, n) {
          return Ae(ge(e), e, n, "a string"), e;
        },
        We = function (e) {
          return e;
        };
      (We.default = function (e) {
        return Ne(
          this,
          (function (e) {
            return function (n) {
      ...
      var Xe = function () {
        ...
        Ge = function (e) {
          return Me(this, Ue("an integer", e));
        },
        $e = function (e) {
          return Me(this, Ue("a number", e));
        },
        Ke = function () {
          return Me(this, Le, { minimum: Ge });
        },
        Ye = function () {
          return Me(this, Be("a non-empty string"));
        },
        Ze = function () {
          return Me(this, Be("a non-empty array"));
        },
        en = function () {
          return Me(this, Be("a non-empty object"));
        },
        nn = function () {
          return Me(this, He);
        },
        ...
        an = function (e) {
          return Me(
            ...
            (function (e) {
              return function (n, t) {
                Ae(Array.isArray(n), n, t, "an array");
                var r = [],
        ...
        fn =
          (function () {
            return Me(this, ze, { minimum: $e, integer: Ke, unique: tn });
          }.bind(We),
          function (e) {
            return Me(
              this,
        ...
        pn = fn(
          an(
            dn({
              authenticatedState: gn("ambiguous", "authenticated", "loggedOut"),
              id: ln(),
              namespace: dn({ code: ln() }).noUnknownFields(),
              primary: cn(),
              xid: ln(),
            }),
          ).required(),
        ...
        vn = function (e) {
          ...
          return (
            void 0 !== u.alloy_debug &&
              p(((n = u.alloy_debug), ge(n) && "true" === n.toLowerCase()), {
                fromConfig: !1,
              }),
            {
              setDebugEnabled: p,
              ...
              !(function (n) {
                var t =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ? arguments[1]
                      : {},
                  r = fe(Object.keys(e), Object.keys(t));
                if (r.length)
                  throw new Error(
        ...
        In = function () {
          var e = [],
            ...
            r = function () {
              var n = P();
              return e.push(n), n.promise;
            };
          return {
            in: function () {
              !(function () {
                for (; e.length; ) e.shift().resolve();
              })(),
                (this.awaitConsent = n);
            },
            out: function () {
              !(function () {
                for (; e.length; ) e.shift().reject(En());
              })(),
                (this.awaitConsent = t);
            },
            pending: function () {
        ...
        Sn = function () {
          var e,
            ...
            i = {
              ...
              isEmpty: function () {
                return de(r) && (!e || de(e)) && (!n || de(n));
              },
              setLastChanceCallback: function (e) {
                t = e;
              },
              ...
              toJSON: function () {
                if ((e && i.mergeXdm(e), n && (r.data = n), t)) {
                  var o = l(r.xdm || {}),
                    a = l(r.data || {});
                  try {
                    t({ xdm: o, data: a }),
                      (!r.xdm && de(o)) || (r.xdm = o),
                      (!r.data && de(a)) || (r.data = a);
                  } catch (e) {}
                }
                return r;
              },
        ...
        xn = { CONFIGURE: "configure", SET_DEBUG: "setDebug" },
        Pn = function (e) {
          var n,
            t = e.logger,
                ...
                optionsValidator: function (e) {
                  return (function (e) {
                    var n = e.options,
                      ...
                      r = dn({
                        type: ln(),
                        xdm: dn({ eventType: ln(), identityMap: pn }),
                        data: dn({}),
                        renderDecisions: cn(),
                        decisionScopes: an(ln()),
                        datasetId: ln(),
                      }).required()(n),
                      o = r.type,
                      i = r.xdm;
      ...
      (jn.namespace = "DataCollector"), (jn.configValidators = {});
      var Nn = function (e) {
          var n = e.config,
            t = e.eventManager,
            r = e.lifecycle,
        ...
        Mn = {
          clickCollectionEnabled: cn().default(!0),
          downloadLinkQualifier: ln()
            .regexp()
            .default(
      ...
      (Tn.namespace = "ActivityCollector"), (Tn.configValidators = Mn);
      var Fn,
        Un,
        Bn,
        _n = function (e, n) {
        ...
        Vn = {
          thirdPartyCookiesEnabled: cn().default(!0),
          idMigrationEnabled: cn().default(!0),
        },
        Ln = function (e) {
          return (
            dn({ namespaces: an(sn("ECID")).nonEmpty() }).noUnknownFields()(e),
            { namespaces: ["ECID"] }
          );
        },
        zn = ce(window, m),
        Hn = function (e) {
          ...
          return {
            ...
            setEcid: function (e) {
              r &&
                !m.get(o) &&
                m.set(o, "MCMID|" + e, { domain: zn, expires: 390 });
            },
          };
        },
        Jn = function (e) {
          var n = e.logger;
          return new Promise(function (e, t) {
            if (O(window.adobe) && O(window.adobe.optIn)) {
        ...
        Wn = "ECID",
        Xn = function (e) {
          e.mergeQuery({ identity: { fetch: [Wn] } });
        },
        Gn =
          ((Fn = function (o) {
            var i, a;
            return (w((i = {}), n, /Edge\/([0-9\._]+)/),
            w(i, t, /Edg\/([0-9\.]+)/),
            w(i, e, /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/),
            w(i, "Firefox", /Firefox\/([0-9\.]+)(?:\s|$)/),
            w(i, "IE", /Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/),
            w(i, "Safari", /Version\/([0-9\._]+).*Safari/),
            (a = i),
            function (e) {
          ...
          function () {
            var e = Un
              ? Un.apply(void 0, arguments)
              : arguments.length <= 0
                ? void 0
                : arguments[0];
            if (Bn.has(e)) return Bn.get(e);
            var n = Fn.apply(void 0, arguments);
            return Bn.set(e, n), n;
          }),
        $n = function (e, n) {
          e.addIdentity(Wn, { id: n });
        },
        Kn = function (e) {
          var n = e.getPayloadsByType("identity:result"),
            t = q(n, function (e) {
              return e.namespace && e.namespace.code === Wn;
            });
        ...
        Yn = function (e) {
          var n = {},
            t = !1,
            r = {
              mergeConfigOverrides: D(n, "meta.configOverrides"),
              mergeState: D(n, "meta.state"),
              mergeQuery: D(n, "query"),
              useIdThirdPartyDomain: function () {
                t = !0;
              },
        ...
        nt = function (e) {
          var n = e.config,
            ...
            u = Qn({ logger: t, orgId: i, awaitVisitorOptIn: Jn }),
            s = Hn({ config: n, getEcidFromVisitor: u }),
            f = (function (e) {
              var n = e.orgId,
                t = se(n, "identity");
              return function () {
                return Boolean(m.get(t));
              };
            })({ orgId: i }),
            d = (function (e) {
              ...
              return function (e) {
                return n({ payload: t(e), action: "identity/acquire" });
              };
            })({ sendEdgeNetworkRequest: o, createIdentityPayload: et }),
            l = (function (e) {
              var n = e.thirdPartyCookiesEnabled,
                t = e.areThirdPartyCookiesSupportedByDefault;
              return function (e) {
                n && t(Gn(window)) && e.useIdThirdPartyDomain();
              };
            })({
            ...
            })({ getLegacyEcid: s.getEcid, addEcidToPayload: $n }),
            p = (function (e) {
              var n = e.orgId,
            ...
            })({ orgId: i, doesIdentityCookieExist: f }),
            v = (function (e) {
              var n,
                t = e.doesIdentityCookieExist,
              ...
              return function (e) {
                ...
                if (n) {
                  a.log("Delaying request while retrieving ECID from server.");
                  var s = n;
                  return (
                    (n = s.catch(function () {
                    ...
                    s
                      .then(function () {
                        a.log("Resuming previously delayed request.");
                      })
                      .catch(function () {
                        return c(r);
                      })
              ...
              setDomainForInitialIdentityPayload: l,
            ...
            h = (function (e) {
              ...
              })({ fireReferrerHideableImage: re, logger: t }),
            });
          return (function (e) {
            var n,
            ...
            return {
              lifecycle: {
                onBeforeRequest: function (e) {
                  ...
                  return (
                    t(n), r({ payload: n, onResponse: o, onRequestFailure: i })
                  );
                },
                onResponse: function (e) {
                  var t = e.response;
                  return n || ((n = a(t)) && o(n)), i(t);
                },
              },
              commands: {
                getIdentity: {
            ...
            ensureSingleIdentity: v,
            addEcidQueryToPayload: Xn,
            setLegacyEcid: s.setEcid,
            handleResponseForIdSyncs: h,
            getEcidFromResponse: Kn,
            getIdentity: d,
            consent: r,
          });
        };
      (nt.namespace = "Identity"), (nt.configValidators = Vn);
      var tt = function (e, n) {
          return (
            "URL destination " +
            (n ? "succeeded" : "failed") +
              ...
              (function (e) {
                e.filter(function (e) {
                  ...
                  var n = e.spec,
                    ...
                    o = n.domain,
                    i = n.ttlDays;
                  m.set(t, r || "", { domain: o || "", expires: i || 10 });
                });
              })(e),
              (function (e, n, t) {
        ...
        ot = function (e) {
          var n = e.logger,
            t = rt({ fireReferrerHideableImage: re, logger: n }),
            r = function (e) {
              var n = e.response;
              if (n) {
                var r = n.getPayloadsByType("activation:push");
                return t(r);
              }
            };
          return {
            lifecycle: { onResponse: r, onRequestFailure: r },
            commands: {},
          };
        };
      (ot.namespace = "Audiences"), (ot.configValidators = {});
      var it,
        at = "__view__",
        ct = "https://ns.adobe.com/personalization/dom-action",
        ut = function (e) {
          var n = e.logger,
          ...
          return {
            lifecycle: {
              onBeforeEvent: function (e) {
                ...
                if (a())
                  return (
                    n.warn("Rendering is disabled, authoring mode."),
                    void c(i, { enabled: !1 })
                  );
                var m = (function (e) {
                  ...
                  return {
                    ...
                    createQueryDetails: function () {
                      var e = k(t);
                      this.isCacheInitialized() || o(e, at) || e.push(at);
                      var n = [
        ...
        mt = function (e) {
          for (
            var n = [],
              t = (function (e) {
                return e.split(dt).filter(pe);
              })(
                (function (e) {
                  return e.replace(gt, vt);
                })(e.trim()),
              ),
              r = t.length,
              o = 0;
            ...
            var i = t[o].replace(pt, "").trim(),
              a = t[o + 1];
            a ? n.push({ sel: i, eq: Number(a) }) : n.push({ sel: i }),
              (o += 2);
          }
          return n;
        },
        ht = function (e) {
          var n = document;
          if (lt(e)) return z(e, n);
          for (var t = mt(e), r = t.length, o = [], i = n, a = 0; a < r; ) {
            var c = t[a],
              u = c.sel,
              s = c.eq,
              f = z(u, i),
        ...
        Rt = function () {
          ...
          if (void 0 === it) {
            ...
            it = n && (n.nonce || n.getAttribute("nonce"));
          }
          return it;
        },
        St = "alloy-prehiding",
            ...
            _t._immediateFn(function () {
              ...
              if (null !== t) {
                ...
                try {
                  ...
                  return void zt(n.promise, e);
                }
                Lt(n.promise, r);
              } else (1 === e._state ? Lt : zt)(n.promise, e._value);
            }))
          : e._deferreds.push(n);
      }
      function Lt(e, n) {
        try {
          ...
          if (n && ("object" == typeof n || "function" == typeof n)) {
            var t = n.then;
            if (n instanceof _t)
              return (e._state = 3), (e._value = n), void Ht(e);
          ...
          (e._state = 1), (e._value = n), Ht(e);
        } catch (n) {
          zt(e, n);
        }
      }
      function zt(e, n) {
        (e._state = 2), (e._value = n), Ht(e);
      }
      function Ht(e) {
        2 === e._state &&
          0 === e._deferreds.length &&
          _t._immediateFn(function () {
            e._handled || _t._unhandledRejectionFn(e._value);
          });
      ...
      (_t.prototype.catch = function (e) {
        return this.then(null, e);
      }),
        (_t.prototype.then = function (e, n) {
          var t = new this.constructor(Bt);
          return Vt(this, new Jt(e, n, t)), t;
        }),
        ...
        (_t.all = function (e) {
          return new _t(function (n, t) {
            if (!Ut(e)) return t(new TypeError("Promise.all accepts an array"));
        ...
        (_t.resolve = function (e) {
          return e && "object" == typeof e && e.constructor === _t
            ? e
            : new _t(function (n) {
                n(e);
              });
        }),
        (_t.reject = function (e) {
          return new _t(function (n, t) {
            t(e);
          });
        }),
        ...
        (_t._unhandledRejectionFn = function (e) {
      ...
      var Wt =
        ...
        Yt = function (e) {
          for (
            ...
            if ($t(c)) {
              var u = c.textContent;
              u && t.push(M(F, i, { textContent: u }));
            }
          }
          return t;
        },
        Zt = function (e) {
          for (var n = z(F, e), t = [], r = n.length, o = 0; o < r; o += 1) {
            var i = n[o];
            if (Kt(i)) {
              var a = bt(i, U);
              a && t.push(a);
            ...
            return (
              (function (e) {
                if (!Dt[e]) {
                  var n = Rt(),
                    t = C({}, n && { nonce: n }),
                    r = M(T, t, { textContent: e + " { visibility: hidden }" });
                  j(document.head, r), (Dt[e] = r);
                }
              })(r),
              Y(t, ht)
                .then(function (n) {
        ...
        yr = function (e, n) {
          ...
          for (var t = ht(e), r = !1, o = 0; o < t.length; o += 1)
            if (t[o] === n) {
              r = !0;
              break;
            }
        ...
        wr = function (e, n) {
          for (
            var t = document.documentElement, r = n.selector, o = n.meta, i = e;
            i && i !== t;
        ...
        Cr = function () {
          var e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : document;
          return -1 !== e.location.href.indexOf("mboxEdit");
        },
        Er = function (e, n) {
          e.mergeMeta({ personalization: C({}, n) });
        },
        Ir = function (e, n) {
          e.mergeQuery({ personalization: C({}, n) });
        },
        kr = function (e, n) {
          return { id: e.id, scope: e.scope, items: n };
        },
        Or = {
          groupDecisionsBySchema: function (e) {
            return (function (e, n) {
              var t = [],
                r = [];
              return (
                e.forEach(function (e) {
                  var o = e.items,
                    ...
                    a = i[0],
                    c = i[1];
                  V(a) && t.push(kr(e, a)), V(c) && r.push(kr(e, c));
                }),
                { domActionDecisions: t, nonDomActionDecisions: r }
              );
            })(e.decisions, e.schema);
          },
          groupDecisionsByScope: function (e) {
            return (function (e, n) {
              var t = [],
                r = {};
              return (
        ...
        Rr = function (e) {
          var n,
            ...
            a = (function (e) {
              ...
              return function (e) {
                var r = e.meta,
                  o = n.createEvent();
                return (
                  o.mergeXdm({ eventType: "display" }), t(o, r), n.sendEvent(o)
                );
              };
            })({ eventManager: i, mergeMeta: Er }),
            c = (function (e) {
              var n = e.eventManager,
                t = e.mergeMeta;
              return function (e) {
                ...
                if (V(c)) {
                  var f = c[0].scope;
                  (u.web = { webPageDetails: { viewName: f } }), t(s, r);
                }
                return s.mergeXdm(u), s.mergeXdm(i), n.sendEvent(s);
              };
            })({ eventManager: i, mergeMeta: Er }),
            u = [],
            s =
            ...
            l = hr({ modules: f, logger: o, executeActions: vr, collect: a }),
            g = (function (e) {
              var n = e.viewCache,
                t = e.executeViewDecisions,
                r = e.collect;
              return function (e) {
                var o = e.viewName;
                n.getView(o).then(function (e) {
                  V(e)
                    ? t(e)
                    : r({
                        meta: {},
                        xdm: { web: { webPageDetails: { viewName: o } } },
                      });
                });
              };
            })({
              viewCache: s,
              executeViewDecisions: hr({
                modules: f,
                logger: o,
                executeActions: vr,
                collect: c,
              ...
              responseHandler: (function (e) {
                ...
                return function (e) {
                  var i = e.decisionsDeferred,
                    ...
                    c = e.response.getPayloadsByType(
                      "personalization:decisions",
                    ),
                    u = a.getViewName();
                  if (0 === c.length)
                    return o(), i.resolve({}), { decisions: [] };
                  var s = n.groupDecisionsBySchema({
                      decisions: c,
                      schema: ct,
                    }),
                    f = s.domActionDecisions,
                    d = s.nonDomActionDecisions,
                    l = n.groupDecisionsByScope({ decisions: f, scope: at }),
                    g = l.pageWideScopeDecisions,
                    p = l.nonPageWideScopeDecisions;
                  if (
                    (de(p) ? i.resolve({}) : i.resolve(p),
                    a.isRenderDecisions())
                  )
                    return t(g), u && r({ viewName: u }), o(), { decisions: d };
                  var v = [].concat(k(g), k(d));
                  return (
                    u && p[u] && v.push.apply(v, k(p[u])), { decisions: v }
                  );
                };
              })({
                decisionsExtractor: Or,
                executeDecisions: l,
                executeCachedViewDecisions: g,
                showContainers: qt,
              }),
              showContainers: qt,
              hideContainers: Pt,
            ...
            v = (function (e) {
              ...
              return function (e) {
                var o = e.event,
                  ...
                  a = t(i, r);
                V(a) &&
                  (o.mergeXdm({ eventType: "click" }), n(o, { decisions: a }));
              };
            })({ mergeMeta: Er, collectClicks: br, clickStorage: u }),
            m = (function (e) {
          ...
          return ut({
            ...
            viewChangeHandler: m,
            onClickHandler: v,
            isAuthoringModeEnabled: Cr,
            mergeQuery: Ir,
            viewCache: s,
          });
        };
      (Rr.namespace = "Personalization"),
        (Rr.configValidators = { prehidingStyle: ln().nonEmpty() });
      var Sr,
        Dr = "2.3.0",
        xr = (function (e) {
          return function (n) {
        ...
        Pr = (function (e) {
          return function (n) {
            ...
            i && (o.screenOrientation = i), S(n, { device: o });
          };
        })(window),
        qr = (function (e) {
          return function (n) {
            ...
            S(n, {
              environment: {
                type: "browser",
                browserDetails: { viewportWidth: t, viewportHeight: r },
              },
            });
          };
        })(window),
        ...
        Ar = { web: xr, device: Pr, environment: qr, placeContext: jr },
        Tr = [Nr, Mr],
        Fr = function (e) {
          return (function (e, n, t, r) {
            var o = e.context,
          ...
          })(e.config, e.logger, Ar, Tr);
        };
      (Fr.namespace = "Context"),
        (Fr.configValidators = { context: an(ln()).default(Object.keys(Ar)) });
      var Ur = function () {
        ...
        _r = dn({ consent: an(on()).required().nonEmpty(), identityMap: pn })
          .noUnknownFields()
          .required(),
        Vr = function (e) {
          var n,
          ...
          return (function (e) {
            ...
            return {
                ...
                setConsent: {
                  ...
                  run: function (e) {
                    ...
                    return (
                      ...
                      t
                        .addTask(function () {
                          return i({ consentOptions: n, identityMap: r });
                        })
                        .catch(function (e) {
                          throw (u(), e);
                        })
              ...
              lifecycle: { onResponse: u, onRequestFailure: u },
            };
          })({
            readStoredConsent: (function (e) {
            ...
            })({ parseConsentCookie: Br, orgId: a, cookieJar: m }),
            taskQueue:
              ((n = 0),
              (t = Promise.resolve()),
              {
            ...
            sendSetConsentRequest: (function (e) {
              ...
              return function (e) {
                ...
                return (
                  ...
                  t({ payload: i, action: "privacy/set-consent" }).then(
                    function () {},
                  )
                );
              };
            })({ createConsentRequestPayload: Ur, sendEdgeNetworkRequest: i }),
            validateSetConsentOptions: _r,
          });
        };
      Vr.namespace = "Privacy";
      var Lr = function () {
          return { eventMergeId: je() };
        },
        zr = function (e) {
          e.config;
          return { commands: { createEventMergeId: { run: Lr } } };
        };
      (zr.namespace = "EventMerge"), (zr.configValidators = {});
      var Hr = function () {
        return {
          commands: {
            getLibraryInfo: {
              run: function () {
                return { libraryInfo: { version: Dr } };
              },
            },
          },
        };
      };
      Hr.namespace = "LibraryInfo";
      var Jr,
        Qr = [jn, Tn, nt, ot, Rr, Fr, Vr, zr, Hr],
        Wr = function (e) {
          var n = e.options,
            ...
            c = o(
              (function (e, n) {
                try {
                  return dn(e).noUnknownFields().required()(n);
                } catch (e) {
                  throw new Error(
        ...
        Gr = function (e) {
          ...
          return function (e, r) {
            ...
            throw (ke({ error: o, message: n + " " + o.message }), o);
          };
        },
        $r = function (e) {
          var n,
                    ...
                    (i.onreadystatechange = function () {
                      4 === i.readyState &&
                        (0 === i.status
                          ...
                          : r({ status: i.status, body: i.responseText }));
                    }),
            ...
            i =
              t.navigator && _(t.navigator.sendBeacon)
                ? (function (e, n, t) {
                    return function (r, o) {
                      var i = new Blob([o], {
                        type: "text/plain; charset=UTF-8",
                      });
                      return e.sendBeacon(r, i)
          ...
          return function (e) {
            var n = e.url,
              t = e.body;
            return (e.documentMayUnload ? i : o)(n, t);
          };
        },
        Kr = function (e) {
        ...
        eo = function (e) {
          var n = e.statusCode,
            t = e.body,
            r = e.parsedBody;
          if ((!r && 204 !== n) || (r && !Array.isArray(r.handle)))
            throw new Error(
              "Unexpected server response with status code " +
                n +
                " and " +
                (t ? "response body: " + t : "no response body."),
            );
        },
        no = function (e) {
          return 429 === e || (e >= 500 && e < 600);
        },
        to = window.__alloyNS,
        ro =
          ((Jr = window),
          function (e) {
            var n = ie + e;
            return {
              session: Re(Jr, "sessionStorage", n),
              persistent: Re(Jr, "localStorage", n),
            };
          }),
        oo = window.console,
        io = function () {
        ...
        ao = {
          debugEnabled: cn().default(!1),
          defaultConsent: gn(kn, On).default(kn),
          edgeConfigId: ln().unique().required(),
          edgeDomain: ln().domain().default("edge.adobedc.net"),
          edgeBasePath: ln().nonEmpty().default("ee"),
          orgId: ln().unique().required(),
          onBeforeEventSend: un().default(ve),
        },
        co = ce(window, m);
      to &&
        to.forEach(function (e) {
          var n = vn({
            ...
            t = n.setDebugEnabled,
            r = n.logger,
            o = n.createComponentLogger,
            i = wn(),
            a = hn(i),
            c = $r({ window: window, logger: r }),
            u = Gr({ errorPrefix: "[" + e + "]", logger: r }),
            s = (function (e) {
              return function (n) {
                var t = n[0],
                  r = n[1],
              ...
              Pn({
                logger: r,
                configureCommand: function (n) {
                  var u = Wr({
                      options: n,
                      componentCreators: Qr,
                      coreConfigValidators: ao,
                      createConfig: Xr,
                      logger: r,
                      setDebugEnabled: t,
                    }),
                    s = Yr({ cookieJar: m, orgId: u.orgId, apexDomain: co }),
                    f = (function (e) {
                      var n = e.logger,
                        t = e.networkStrategy,
                        r = e.isRetryableHttpStatusCode;
                      return function (e) {
                        var o = e.payload,
                          i = e.url,
                          a = e.requestId,
                        ...
                        return (
                          ...
                          (function e() {
                            ...
                            return t({
                              url: i,
                              body: c,
                              documentMayUnload: o.getDocumentMayUnload(),
                            }).then(function (t) {
                              if (r(t.status) && u < 3) return e(u + 1);
                              var o;
                              try {
                                o = JSON.parse(t.body);
                              } catch (e) {}
                              return (
                                n.logOnNetworkResponse(
                                  C(
                                    ...
                                    t,
                                    { parsedBody: o, retriesAttempted: u },
                                  ),
                                ),
                                {
                                  statusCode: t.status,
                    ...
                    g = (function (e) {
                      var n = e.config,
                        ...
                        c = e.validateNetworkResponseIsWellFormed,
                        u = n.edgeDomain,
                        s = n.edgeBasePath,
                        f = n.edgeConfigId;
                      return function (e) {
                        var n = e.payload,
                          l = e.action,
                          g = e.runOnResponseCallbacks,
                          p = void 0 === g ? ve : g,
                          v = e.runOnRequestFailureCallbacks,
                          m = void 0 === v ? ve : v,
                          h = x();
                        h.add(t.onResponse), h.add(p);
                        var y = x();
                        return (
                          y.add(t.onRequestFailure),
                          y.add(m),
                          t
                            .onBeforeRequest({
                              payload: n,
                            ...
                            .then(function () {
                              var e = n.getUseIdThirdPartyDomain()
                                ...
                                i =
                                  ...
                                  t;
                              return (
                                r.cookiesToPayload(n, e),
                                o({ payload: n, url: i, requestId: t })
                              );
                            })
                            .then(function (e) {
                              return c(e), e;
                            ...
                            .catch(function (e) {
                              ...
                              return y.call({ error: e }).then(n, n);
                            })
                            .then(function (e) {
                              var n = e.parsedBody,
                                t = e.statusCode,
                                o = i(n);
                              if ((r.responseToCookies(o), t >= 400)) {
                                var c = function () {
                                  return a(o);
                                };
                                return y.call({ response: o }).then(c, c);
                              }
                              return h.call({ response: o }).then(function (e) {
                                a(o);
                                var n = e.shift() || [],
                                  t = e.shift() || [],
                                  r = e;
                      ...
                      lifecycle: a,
                      cookieTransfer: s,
                      sendNetworkRequest: f,
                      createResponse: Dn,
                      processWarningsAndErrors: l,
                      validateNetworkResponseIsWellFormed: eo,
                    }),
                    p = (function (e) {
                        ...
                        setConsent: function (e) {
                          switch (e.general) {
                            case kn:
                              ...
                              break;
                            case "out":
                              t.warn("Some commands may fail. " + bn), n.out();
                              break;
                            case On:
                              t.warn(
                    ...
                    })({ generalConsentState: In(), logger: r }),
                    v = (function (e) {
                      var n = e.config,
                        t = e.logger,
                        r = e.lifecycle,
                      ...
                      return {
                        ...
                        sendEvent: function (e) {
                          ...
                          return r
                            ...
                            .then(function () {
                              return f.addEvent(e), o.awaitConsent();
                            })
                            .then(function () {
                              return r.onBeforeDataCollectionRequest({
                                payload: f,
                                onResponse: d.add,
                                onRequestFailure: l.add,
                              });
                            ...
                            .then(function () {
                              var n = e.getDocumentMayUnload();
                              return c({
                                payload: f,
                                action: n ? "collect" : "interact",
                                runOnResponseCallbacks: d.call,
                                runOnRequestFailureCallbacks: l.call,
                              });
                            });
                        },
                      };
                      ...
                      consent: p,
                      createEvent: Sn,
                      createDataCollectionRequestPayload: Zr,
                      sendEdgeNetworkRequest: g,
                    });
                  return (function (e) {
                    ...
                    lifecycle: a,
                    componentRegistry: i,
                    getImmediatelyAvailableTools: function (n) {
                      var t = o(n);
                      return {
                        config: u,
                        consent: p,
                ...
                handleError: u,
                validateCommandOptions: qn,
              }),
            ),
            f = window[e].q;
          (f.push = s), r.logOnInstanceCreated({ instance: s }), f.forEach(s);
        });
    })();
