          ...
          for (o in u)
            u.hasOwnProperty(o) &&
              ...
              ((!(d = u[o]) && "number" != typeof d) ||
                ((t[(o = ("contextData." + o).replace(/\./g, c))] = d),
                (n = !0)));
        }
  ...
  "function" != typeof window.DIL &&
    ((window.DIL = function (s) {
      ...
      var E,
        ...
        q = {
          ...
          customQueryParams: function (e) {
            return (
              V.isEmptyObject(e) || x.extendObject(T, e, R.reservedKeys), this
            );
          },
          ...
          submit: function (e) {
            return (
              (T.isDefaultRequest = !!e), M.submitRequest(T), (T = {}), this
            );
          },
          getPartner: function () {
            return I;
      ...
      A.IS_IE_LESS_THAN_10 &&
        ...
        (this.initConfig = s),
        (this.logger = L),
        C && ((this.variables = P), (this.callWindowLoadFunctions = B));
    }),
