(function () {
  ...
  window._satellite.container = {
    buildInfo: {
      buildDate: "2020-11-05T05:16:14Z",
    ...
    extensions: {
      "adobe-target-v2": {
        ...
        modules: {
          "adobe-target-v2/lib/loadTarget.js": {
            ...
            script: function (module, exports, require, turbine) {
              ...
              var augmentTracker = turbine.getSharedModule(
                "adobe-analytics",
                "augment-tracker",
              );
          ...
          "adobe-target-v2/lib/firePageLoad.js": {
            ...
            script: function (module, exports, require, turbine) {
              ...
              function isLibraryPresent() {
                return (
                  win.adobe && win.adobe.target && win.adobe.target.VERSION
                );
              }
          ...
          "adobe-target-v2/lib/modules/load-target.js": {
            script: function (module, exports, require, turbine) {
              ...
              function isStandardMode(document) {
                ...
                var ie9OrModernBrowser = documentMode
                  ? documentMode >= 9
                  : true;
              ...
              function initLibrarySettings() {
                ...
                overrideProps(
                  targetSettings,
                  win.targetGlobalSettings || {},
                  OVERRIDABLE_SETTINGS,
                );
                overrideProps(targetSettings, TARGET_DEFAULT_SETTINGS || {}, [
                  "version",
                ]);
          ...
          "adobe-target-v2/lib/modules/optin.js": {
            script: function (module, exports, require, turbine) {
              ...
              function isOptInAPIAvailable(optIn) {
                return (
                  isFunction(optIn[FETCH_PERMISSIONS]) &&
                  isFunction(optIn[IS_APPROVED])
                );
              }
            ...
            script: function (module, exports, require, turbine) {
              ...
              function hash(string) {
                ...
                for (var i = 0; i < length; i += 1) {
                  result =
                    ((result << 5) - result + string.charCodeAt(i)) &
                    0xffffffff;
                }
                return result;
              }
              ...
              function isPlainObject(value) {
                ...
                var Ctor =
                  hasOwnProperty$1.call(proto, "constructor") &&
                  proto.constructor;
                return (
              ...
              var baseReduce = function baseReduce(
                iteratee,
                accumulator,
                collection,
              ) {
              ...
              var ALREADY_INITIALIZED =
                "Adobe Target has already been initialized.";
              ...
              var EXECUTE_OR_PREFETCH_REQUIRED =
                "execute or prefetch is required";
              var EXECUTE_OR_PREFETCH_NOT_ALLOWED =
                "execute or prefetch is not allowed";
              ...
              var OVERRIDE_MBOX_EDGE_SERVER_TIMEOUT =
                "overrideMboxEdgeServerTimeout";
              ...
              function overrideSettingsIfRequired(settings, globalSettings) {
                ...
                if (!isNil(globalSettings[GLOBAL_MBOX_AUTO_CREATE])) {
                  settings[PAGE_LOAD_ENABLED] =
                    globalSettings[GLOBAL_MBOX_AUTO_CREATE];
                }
              ...
              function overrideFromGlobalSettings(win, doc, settings) {
                ...
                settings[ENABLED] =
                  isStandardMode(doc) && isIE10OrModernBrowser(doc);
                overrideSettingsIfRequired(
                  settings,
                  win[GLOBAL_SETTINGS] || {},
                );
              }
              function initConfig(settings) {
                ...
                config[DEVICE_ID_LIFETIME] =
                  settings[DEVICE_ID_LIFETIME] / 1000;
                config[SESSION_ID_LIFETIME] =
                  settings[SESSION_ID_LIFETIME] / 1000;
                config[SCHEME] =
                  config[SECURE_ONLY] || fileProtocol ? "https:" : "";
              }
              function getConfig() {
                return config;
              }
              ...
              var parseUri = function parseURI(str, opts) {
                ...
                var m =
                  o.parser[opts.strictMode ? "strict" : "loose"].exec(str);
                var uri = {};
                var i = 14;
              ...
              function readCookies() {
                var cookies = map(
                  deserialize,
                  getInternalCookies(getCookie(MBOX_COOKIE)),
                );
              ...
              function saveCookies(cookiesMap, domain) {
                ...
                var maxExpires = Math.abs(
                  getMaxExpires(cookies) * 1000 - now(),
                );
              ...
              function debug(win, args) {
                ...
                if (isDebugEnabled()) {
                  console.debug.apply(
                    console,
                    [ADOBE_TARGET_PREFIX].concat(args),
                  );
                }
              }
              ...
              var $ = (function (window) {
                var Zepto = (function () {
                  ...
                  zepto.fragment = function (html, name, properties) {
                    ...
                    if (!dom) {
                      ...
                      dom = $.each(
                        _slice.call(container.childNodes),
                        function () {
                  ...
                  function extend(target, source, deep) {
                    for (key in source) {
                      ...
                      } else if (source[key] !== undefined$1)
                  ...
                  zepto.qsa = function (element, selector) {
                    var found,
                      ...
                      nameOnly =
                        maybeID || maybeClass ? selector.slice(1) : selector,
                  ...
                  $.each = function (elements, callback) {
                    ...
                    if (likeArray(elements)) {
                      for (i = 0; i < elements.length; i++) {
                        if (
                          callback.call(elements[i], i, elements[i]) === false
                        )
                          return elements;
                      }
                    } else {
                  ...
                  $.fn = {
                    ...
                    contents: function contents() {
                      return this.map(function () {
                        return (
                          this.contentDocument || _slice.call(this.childNodes)
                        );
                      });
                    },
                      ...
                      $.fn[operator] = function () {
                        ...
                        return this.each(function (_, target) {
                          ...
                          nodes.forEach(function (node) {
                            ...
                            if (
                              isNotBlank(scriptNonce) &&
                              node.tagName === "SCRIPT"
                            ) {
                              node.setAttribute("nonce", scriptNonce);
                            }
                            if (
                              isNotBlank(styleNonce) &&
                              node.tagName === "STYLE"
                            ) {
                            ...
                            if (parentInDocument)
                              traverseNode(node, function (el) {
                                if (
                                  ...
                                  (!el.type ||
                                    SCRIPT_TYPES.test(el.type.toLowerCase())) &&
                                  !el.src
                                ) {
                                  executeScript(
                                    document,
                ...
                (function ($) {
                  ...
                  function realEvent(type) {
                    return (
                      hover[type] || (focusinSupported && focus[type]) || type
                    );
                  }
                  function add(
                    element,
              ...
              var MO_OBJECT =
                window$1.MutationObserver || window$1.WebkitMutationObserver;
              ...
              function getMoImmediateFn() {
                ...
                var twiddleNode = function twiddleNode() {
                  textnode.textContent =
                    textnode.textContent.length > 0 ? "" : "a";
                };
                var callbacks = [];
              ...
              function setEdgeCluster(id) {
                ...
                var expires = new Date(
                  now() + config[OVERRIDE_MBOX_EDGE_SERVER_TIMEOUT],
                );
              ...
              function initAuthoringCode() {
                ...
                loadScript(authoringScriptUrl).then(success)["catch"](error);
              }
              ...
              var TRUE_AUDIENCE_IDS =
                "at_preview_evaluate_as_true_audience_ids";
              var FALSE_AUDIENCE_IDS =
              ...
              function extractQaMode(queryString) {
                ...
                if (
                  isNotBlank(listedActivitiesOnly) &&
                ...
                if (isNotBlank(trueAudiences)) {
                  result.evaluateAsTrueAudienceIds =
                    extractAudienceIds(trueAudiences);
                }
                var falseAudiences = query[FALSE_AUDIENCE_IDS];
                if (isNotBlank(falseAudiences)) {
                  result.evaluateAsFalseAudienceIds =
                    extractAudienceIds(falseAudiences);
                }
              ...
              function addHidingSnippet(config) {
                ...
                append(
                  createStyleMarkup(BODY_STYLE_ID, bodyHiddenStyle),
                  HEAD_TAG,
                );
              }
                ...
                return reduce(
                  function (acc, value, key) {
                    ...
                    if (hasAuthState(value)) {
                      item[AUTHENTICATED_STATE] = getAuthenticatedState(
                        value[AUTH_STATE],
                      );
                    }
                    acc.push(item);
              ...
              function getAsyncValues(
                ...
                return timeout(requests, visitorApiTimeout, TIMEOUT_MESSAGE)[
                  "catch"
                ](handleError);
              }
              ...
              function getVisitorInstance() {
                ...
                var sdidParamExpiry =
                  config[SUPPLEMENTAL_DATA_ID_PARAM_TIMEOUT];
              ...
              function executeAsyncDataProviders(win) {
                ...
                return all(map(convertToPromise, validProviders)).then(
                  collectParams,
                );
              }
              ...
              function isPair(pair) {
                return (
                  !isEmpty(pair) && pair.length === 2 && isNotBlank(pair[0])
                );
              }
              ...
              function getParamsAll(mboxParams) {
                return assign(
                  {},
                  mboxParams,
                  functionToParams(window$1.targetPageParamsAll),
                );
              }
              ...
              function getAsyncThirdPartyData() {
                ...
                return all([
                  visitorValues.then(throwIfOptout),
                  dataProvidersParams,
                ]);
              }
              ...
              function getAllParams(providersParams) {
                ...
                return assign(
                  {},
                  providersParams,
                  getTargetPageParams(globalMbox),
                );
              }
              ...
              function createPrefetch(request, allParams) {
                var _request$prefetch = request.prefetch,
                  prefetch =
                    _request$prefetch === void 0 ? {} : _request$prefetch;
                var result = {};
                if (isEmpty(prefetch)) {
                  return result;
                }
              ...
              function createAnalytics(consumerId, request) {
                ...
                var _request$experienceCl = request.experienceCloud,
                  experienceCloud =
                    _request$experienceCl === void 0
                      ? {}
                      : _request$experienceCl;
                var _experienceCloud$anal = experienceCloud.analytics,
                  analytics =
                    _experienceCloud$anal === void 0
                      ? {}
                      : _experienceCloud$anal;
              ...
              function getRedirectUriParams(uri) {
                ...
                result[SDID_PARAM] = param.replace(
                  /\|TS=\d+/,
                  "|TS=" + nowInSeconds,
                );
                return result;
              ...
              function createUrlInternal(url, params, uriParamsFunc) {
                ...
                var anchor = isBlank(parsedUri.anchor)
                  ? ""
                  : "#" + parsedUri.anchor;
                var uriParams = uriParamsFunc(parsedUri);
                var queryString = stringifyQueryString(
                  assign({}, uriParams, params),
                );
              ...
              function processClickTrackId(action) {
                ...
                var selector = action[SELECTOR];
                action[SELECTOR] = selector.replace(
                  CLICK_TRACK_REPLACE_PATTERN,
                  "",
                );
              ...
              function createActionsOption(option) {
                ...
                var processedActions = filter(
                  notNull$1,
                  map(processAction, actions),
                );
              ...
              function getResponseTokens() {
                ...
                var prefetchMboxesTokens = flatten(
                  map(getTokens, prefetchMboxes),
                );
              ...
              function getRedirect() {
                ...
                var mboxesOpts = flatten(
                  filterNotNil(map(selectOptions, mboxes)),
                );
                var options = flatten([pageLoadOpts, mboxesOpts]);
                var actions = flatten(
                  map(selectContent, filter(isActions, options)),
                );
              ...
              function getAnalyticsDetails() {
                ...
                var prefetchMboxesDetails = flatten(
                  map(getAnalytics, prefetchMboxes),
                );
              ...
              function processExecuteMboxes(httpContext) {
                ...
                return all(map(processExecuteMbox, validMboxes)).then(
                  filterNotNil,
                );
              }
              ...
              function getRequestView(request) {
                var _request$prefetch2 = request.prefetch,
                  prefetch =
                    _request$prefetch2 === void 0 ? {} : _request$prefetch2;
              ...
              function loadImage(src) {
                ...
                return getAttr(
                  SRC,
                  setAttr(SRC, src, wrap("<" + IMAGE_TAG + "/>")),
                );
              }
              ...
              function getScriptsUrls(html) {
                return filter(
                  isNotBlank,
                  map(getUrl, toArray(find(SCRIPT, html))),
                );
              }
              ...
              var HEAD_TAGS_SELECTOR =
                SCRIPT_TAG + "," + LINK_TAG + "," + STYLE_TAG;
              ...
              function isClickTracking(action) {
                return (
                  action[TYPE] === TRACK_CLICK || action[TYPE] === SIGNAL_CLICK
                );
              }
              ...
              function createSyncNotificationRequest(
                consumerId,
                params,
                notifications,
              ) {
              ...
              function createAsyncNotificationRequest(
                consumerId,
                params,
                notifications,
              ) {
                var request = createRequest(consumerId);
                return createAsyncDeliveryRequest(request, params).then(
                  function (result) {
                    result.notifications = notifications;
                    return result;
                  },
              ...
              function sendEventNotification(source, type, token) {
                ...
                var request = createSyncNotificationRequest(uuid(), params, [
                  notification,
                ]);
              ...
              function sendMboxEventNotification(name, type, token) {
                ...
                var request = createSyncNotificationRequest(name, params, [
                  notification,
                ]);
              ...
              function sendMboxesRenderedNotifications(items) {
                ...
                forEach(function (item) {
                  ...
                  var _data$eventTokens = data.eventTokens,
                    eventTokens =
                      _data$eventTokens === void 0 ? [] : _data$eventTokens;
                  if (isEmpty(eventTokens)) {
                    return;
                  }
                  notifications.push(
                    createMboxNotification(mbox, type, eventTokens),
                  );
                }, items);
                if (isEmpty(notifications)) {
                  return;
                }
                var request = createSyncNotificationRequest(
                  globalMbox,
                  {},
                  notifications,
                );
              ...
              function sendViewTriggeredNotifications(options) {
                ...
                createAsyncNotificationRequest(name, params, [
                  notification,
                ]).then(function (request) {
              ...
              function sendViewRenderedNotifications(item) {
                ...
                var _data$eventTokens2 = data.eventTokens,
                  eventTokens =
                    _data$eventTokens2 === void 0 ? [] : _data$eventTokens2;
                if (isEmpty(eventTokens)) {
                  return;
                }
                var name = view.name,
                ...
                var request = createSyncNotificationRequest(name, {}, [
                  notification,
                ]);
                request.impressionId = impressionId;
              ...
              function removePreviousHandlersFromCache(
                currentViewName,
                type,
                selector,
              ) {
              ...
              function attachMetricEventHandlers(
                name,
                fromView,
                metrics,
                notifyFunc,
              ...
              var createRenderSuccess = function createRenderSuccess(
                eventToken,
              ) {
              ...
              function hideAllViews(context) {
                var _context$prefetch = context.prefetch,
                  prefetch =
                    _context$prefetch === void 0 ? {} : _context$prefetch;
                var _prefetch$views = prefetch.views,
                  views = _prefetch$views === void 0 ? [] : _prefetch$views;
                if (isEmpty(views)) {
                  return;
              ...
              function hasSelectors(action) {
                return (
                  isNotBlank(action.selector) && isNotBlank(action.cssSelector)
                );
              }
              ...
              function createRenderingContext(selector, context) {
                ...
                var _result$execute = result.execute,
                  ...
                  prefetch =
                    _result$prefetch === void 0 ? {} : _result$prefetch;
                var _execute$pageLoad = execute.pageLoad,
                  pageLoad =
                    _execute$pageLoad === void 0 ? {} : _execute$pageLoad,
                  _execute$mboxes = execute.mboxes,
              ...
              function renderContext(context) {
                ...
                var _execute$pageLoad2 = execute.pageLoad,
                  pageLoad =
                    _execute$pageLoad2 === void 0 ? {} : _execute$pageLoad2,
                ...
                var _context$prefetch2 = context.prefetch,
                  prefetch =
                    _context$prefetch2 === void 0 ? {} : _context$prefetch2;
                var _prefetch$mboxes2 = prefetch.mboxes,
                  prefetchMboxes =
                    _prefetch$mboxes2 === void 0 ? [] : _prefetch$mboxes2,
                  _prefetch$metrics = prefetch.metrics,
                  metrics =
                    _prefetch$metrics === void 0 ? [] : _prefetch$metrics;
                if (!isEmpty(prefetchMboxes)) {
              ...
              function handleSuccess(response) {
                ...
                executeApplyOffers(options, skipPrehiding)["catch"](
                  handleError$1,
                );
              }
              ...
              function processServerState(config) {
                ...
                var scrubbedResponse = scrubServerStateResponse(
                  config,
                  response,
                );
              ...
              function sendNotifications(options) {
                ...
                var validationResult =
                  validateSendNotificationsOptions(options);
                var error = validationResult[ERROR];
                if (!validationResult[VALID]) {
              ...
              function normalizeOptions(config, options) {
                ...
                result[PARAMS] = assign(
                  {},
                  getTargetPageParams(mbox),
                  optsParams,
                );
                result[TIMEOUT] = getTimeout(config, options[TIMEOUT]);
                result[SUCCESS] = isFunction(options[SUCCESS])
                  ? options[SUCCESS]
                  : noop;
                result[ERROR] = isFunction(options[ERROR])
                  ? options[ERROR]
                  : noop;
                return result;
              }
              function shouldTrackBySelector(options) {
                ...
                return (
                  isNotBlank(type) &&
                  (isNotBlank(selector) || isElement(selector))
                );
              }
              function trackImmediateInternal(options) {
                ...
                var request = createSyncNotificationRequest(mbox, params, [
                  notification,
                ]);
          ...
          "adobe-target-v2/lib/modules/object-override.js": {
            script: function (module, exports, require, turbine) {
              ...
              module.exports = function (overriden, overriding, subset) {
                Object.keys(overriding)
                  .filter(subsetFilter, { subset: subset })
          ...
          "adobe-target-v2/lib/modules/page-load.js": {
            script: function (module, exports, require, turbine) {
              ...
              module.exports = function (settings) {
                ...
                overrideProps(targetSettings, settings, [
                  "bodyHidingEnabled",
                  "bodyHiddenStyle",
                ]);

                overrideProps(targetSettings, win.targetGlobalSettings || {}, [
                  "enabled",
                  "bodyHidingEnabled",
                  "bodyHiddenStyle",
                ]);
                overrideProps(
                  targetSettings,
                  _librarySettings.TARGET_DEFAULT_SETTINGS || {},
                  ["version"],
                );
        ...
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/4bbb6b9dc376/99fc0f3e310e/hostedLibFiles/EP269792aa7319457ea7dd670d3f2f68e5/",
      },
      core: {
        displayName: "Core",
        modules: {
        ...
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/4bbb6b9dc376/99fc0f3e310e/hostedLibFiles/EP2e2f86ba46954a2b8a2b3bb72276b9f8/",
      },
      "adobe-analytics": {
        ...
        modules: {
          ...
          "adobe-analytics/src/lib/sharedModules/getTracker.js": {
            script: function (module, exports, require, turbine) {
              ...
              var mcidInstance = turbine.getSharedModule(
                "adobe-mcid",
                "mcid-instance",
              );
              ...
              var updateTrackerVersion = function (tracker) {
                turbine.logger.info(
                  'Setting version on tracker: "' + version + '".',
                );
                ...
                if (typeof tracker.tagContainerMarker !== "undefined") {
                  ...
                  tracker.version.substring(tracker.version.length - 5) !==
                    "-" + version
                ) {
              ...
              var updateTrackerVariables = function (
                trackerProperties,
                customSetup,
                tracker,
              ) {
              ...
              var settingsHelper = {
                ...
                getReportSuites: function (reportSuitesData) {
                  ...
                  if (reportSuitesData[turbine.buildInfo.environment]) {
                    reportSuiteValues =
                      reportSuitesData[turbine.buildInfo.environment];
                  }
          ...
          "adobe-analytics/src/lib/helpers/applyTrackerVariables.js": {
            script: function (module, exports, require, turbine) {
              ...
              var buildLinkTrackVars = function (
                tracker,
                newTrackerProperties,
                addEvents,
              ) {
                var linkTrackVarsValues = Object.keys(
                  newTrackerProperties,
              ...
              var buildLinkTrackEvents = function (tracker, eventsData) {
                ...
                return linkTrackEventsValues
                  .filter(function (value, index) {
                    return (
                      value !== "None" &&
                      onlyUnique(value, index, linkTrackEventsValues)
                    );
                  })
                  .join(",");
              };
              ...
              var variablesTransform = function (
                store,
                keyName,
                trackerProperties,
              ) {
                var dynamicVariablePrefix =
                  trackerProperties.dynamicVariablePrefix || "D=";
              ...
              var transformers = {
                ...
                campaign: function (store, keyName, trackerProperties) {
                  if (trackerProperties[keyName].type === "queryParam") {
                    ...
                    store[keyName] =
                      queryParams[trackerProperties[keyName].value];
                  } else {
              ...
              module.exports = function (tracker, trackerProperties) {
                ...
                if (newProperties.events) {
                  if (tracker.events && tracker.events.length > 0) {
                    newProperties.events =
                      tracker.events + "," + newProperties.events;
                  }
                }
                ...
                var linkTrackVars = buildLinkTrackVars(
                  tracker,
                  newProperties,
                  hasEvents,
                );
            ...
            script: function (module, exports, require, turbine) {
              ...
              var getUrlsToLoad = function (settings) {
                ...
                if (settingsHelper.isAudienceManagementEnabled(settings)) {
                  ...
                  settings.moduleProperties.audienceManager.config.visitorService =
              ...
              var getTrackerFromVariable = function (trackerVariableName) {
                if (window[trackerVariableName]) {
                  ...
                  throw new Error(
                    'Cannot find the global variable name: "' +
                      trackerVariableName +
                      '".',
                  );
                }
          ...
          "adobe-analytics/src/lib/helpers/pollHelper.js": {
            script: function (module, exports, require, turbine) {
              ...
              var found = function (resolve, variableName, result) {
                turbine.logger.info(
                  'Found property located at: "' + variableName + '"].',
                );
                resolve(result);
              };
        ...
        settings: {
          ...
          libraryCode: {
            ...
            accounts: {
              staging: ["ujslatest"],
              production: ["ujslatest"],
              development: ["ujslatest"],
            },
            useActivityMap: true,
        ...
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/4bbb6b9dc376/99fc0f3e310e/hostedLibFiles/EPbde2f7ca14e540399dcc1f8208860b7b/",
      },
      "aam-dil-extension": {
        ...
        modules: {
          "aam-dil-extension/src/lib/sharedModules/dilinstance.js": {
            script: function (module, exports, require, turbine) {
              ...
              turbine.getSharedModule("adobe-mcid", "mcid-instance");
              ...
              if (excludePathsMatched(document.location.pathname)) {
                logger.warn(
                  "AAM DIL extension not loaded. One of the path exclusions matches the current path.",
                );
              } else {
                try {
                  var initConfig = settings.dilInitConfigData.parsedData;

                  dilInstance = DIL.getDil(
                    initConfig.partner,
                    initConfig.containerNSID,
                  );
                  ...
                  if (!(dilInstance instanceof DIL)) {
                    ...
                    if (settings.useGoogleAnalytics) {
                      var ga =
                        settings.googleAnalyticsData.parsedData
                          .variableNameForGoogleAnalytics || "ga";

                      DIL.modules.GA.submitUniversalAnalytics(
                        window[ga],
                        dilInstance,
                      );
                      logger.log(
                        "DIL.modules.GA.submitUniversalAnalytics called.",
                      );
                    }
                  } else {
                    logger.log(
                      "Using existing DIL instance. Not attempting to reinvoke DIL.modules.siteCatalyst.init and DIL.modules.GA.submitUniversalAnalytics",
                    );
                  }
                } catch (e) {
                  try {
                  ...
                  t = {
                    ...
                    init: function (e, t, s) {
                      try {
                        ...
                        t instanceof DIL
                          ? ((this.dil = t),
                            (n.partner = this.dil.api.getPartner()))
                    ...
                    constructTrackVars: function (e) {
                      var t,
                        ...
                        o = [];
                      if (
                        this.defaultTrackVarsObj !==
                        Object(this.defaultTrackVarsObj)
                      ) {
                        for (
                    ...
                    addToSignals: function (e, t) {
                      return (
                        ...
                        null != t &&
                        "" !== t &&
                        (this.signals[e] instanceof Array ||
                          (this.signals[e] = []),
                    ...
                    Stuffer: {
                        ...
                        try {
                          (this.dil = null),
                            ...
                            e instanceof DIL
                              ? ((this.dil = e),
                                (this.v =
                                  this.dil.validators.isPopulatedString),
                                (this.cookieName = this.v(t) ? t : "aam_ga"),
                                (this.delimiter = this.v(s) ? s : "|"))
                              : this.handle(
                                  {
                                    message:
                                      "dilInstance is not a valid instance of DIL",
                                  },
                      ...
                      process: function (e) {
                        ...
                        if (h) {
                          ...
                          this.errorMessage =
                            "Cookie name and value not found in json";
                    ...
                    init: function (e, t, s, n) {
                      try {
                        var f = this,
                          ...
                          p = function (e) {
                            return (
                              (i.message = e), DIL.errorModule.handleError(i), e
                            );
                          };
                        if (
                        ...
                        if (
                          ((this.dil = t),
                          (i.partner = t.api.getPartner()),
                          e !== Object(e))
                        )
                          return p(
                            "siteCatalystReportingSuite is not an object",
                          );
                        var r = e;
                        return (
                          (window.AppMeasurement_Module_DIL = r.m_DIL =
                            function (e) {
                              var t =
                                "function" == typeof e.m_i
                                  ? e.m_i("DIL")
                                  : this;
                              if (t !== Object(t))
                              ...
                              (t.trackVars = f.constructTrackVars(s)),
                                ...
                                (t._t = function () {
                                  ...
                                  if (d !== Object(d))
                                    return p(
                                      "Error in m._t function: s is not an object",
                                    );
                                  if (a.d) {
                        ...
                        if ((t = e.names) instanceof Array && (i = t.length))
                          for (n = 0; n < i; n++)
                            "string" == typeof (r = t[n]) &&
                              ...
                              u.push(r);
                        if (
                          (s = e.iteratedNames) instanceof Array &&
                          (i = s.length)
                        )
                          for (n = 0; n < i; n++)
                            if (
                      ...
                      if (e.contextData === Object(e.contextData)) {
                        ...
                        if (
                          ...
                          for (i = 0, r = l.length; i < r; i++)
                            (a = l[i]),
                              this.dil.validators.isPopulatedString(a) &&
                                (h[a] = !0);
                        for (o in u)
                          u.hasOwnProperty(o) &&
                            !h[o] &&
                ...
                "function" != typeof window.DIL &&
                  ((window.DIL = function (s) {
                    ...
                    s !== Object(s) && (s = {}),
                      ...
                      (d =
                        "boolean" == typeof s.isCoopSafe ? s.isCoopSafe : null),
                      ...
                      R = {
                          ...
                          process: function (e) {
                            try {
                              ...
                              if (
                                ...
                                "function" !=
                                  typeof s.getMarketingCloudVisitorID ||
                          ...
                          getCustomerIDsQueryString: function (e) {
                            ...
                            if ((i = a.length))
                              for (n = 0; n < i; n++)
                                r +=
                                  "&d_cid_ic=" +
                                  x.encodeAndBuildRequest(a[n], "%01");
                            return r;
                          },
                        ...
                        registerRequest: function (e) {
                          var t,
                            s = this.firingQueue;
                          e === Object(e) &&
                            (s.push(e), e.isDefaultRequest || (f = !0)),
                            this.firing ||
                              !s.length ||
                              (i && !DIL.windowLoaded) ||
                    ...
                    var E,
                      ...
                      q = {
                        traits: function (e) {
                          return (
                            V.isValidPdata(e) &&
                              (T.sids instanceof Array || (T.sids = []),
                              x.extendArray(T.sids, e)),
                            this
                          );
                        },
                        pixels: function (e) {
                        ...
                        customQueryParams: function (e) {
                          return (
                            V.isEmptyObject(e) ||
                              x.extendObject(T, e, R.reservedKeys),
                            this
                          );
                        },
                        ...
                        result: function (e) {
                          return (
                            "function" == typeof e && (T.callback = e), this
                          );
                        },
                        afterResult: function (e) {
                          return (
                            "function" == typeof e && (T.postCallbackFn = e),
                            this
                          );
                        },
                      ...
                      M = {
                        ...
                        submitRequest: function (e) {
                          return (
                            R.registerRequest(M.createQueuedRequest(e)), !0
                          );
                        },
                        createQueuedRequest: function (e) {
                          ...
                          return (
                            ...
                            (e.logdataArray = x.convertObjectToKeyValuePairs(
                              e.logdata,
                              "=",
                              !0,
                            )),
                        ...
                        defaultCallback: function (e, t) {
                          ...
                          if (
                            ...
                            for (i = 0; i < n; i++)
                              (r = s[i]) &&
                                ...
                                (void 0 !== (d = r.ttl) && "" !== d) ||
                                  (d = Math.floor(
                                    x.getMaxCookieExpiresInMinutes() / 60 / 24,
                                  )),
                                (u =
                                  r.dmn ||
                          ...
                          V.isPopulatedString(f) &&
                            (V.isEmptyObject(p) ||
                              (("string" == typeof (l = p.path) && l.length) ||
                                (l = "/"),
                        ...
                        makeRequestSrcData: function (r) {
                          ...
                          var i,
                            ...
                            l = a.adms.instance
                              ? a.adms.getCustomerIDsQueryString(
                                  a.adms.getCustomerIDs(),
                                )
                              : "",
                            h = (function () {
                              var e,
                              ...
                              for (e in r)
                                if (
                                  ...
                                  if (
                                    ((t = r[e]), (e = d(e)), t instanceof Array)
                                  )
                        ...
                        fireRequest: function (e) {
                          if ("img" === e.tag) this.fireImage(e);
                            ...
                            var t = R.declaredId,
                              s =
                                t.declaredId.request || t.declaredId.init || {},
                              n = {
                                dpid: s.dpid || "",
                                dpuuid: s.dpuuid || "",
                              };
                        ...
                        setCookie: function (e, t, s, n, i, r) {
                          ...
                          (s = s && 1e3 * s * 60),
                            (document.cookie =
                              ...
                              (s
                                ? ";expires=" +
                                  new Date(a.getTime() + s).toUTCString()
                                : "") +
                              (n ? ";path=" + n : "") +
                              (i ? ";domain=" + i : "") +
                              (r ? ";secure" : ""));
                    ...
                    A.IS_IE_LESS_THAN_10 &&
                      ...
                      C &&
                        ((this.variables = P),
                        (this.callWindowLoadFunctions = B));
                  }),
                  ...
                  window.DIL &&
                    ...
                    (DIL.tools.getSearchReferrer = function (e, t) {
                      ...
                      return (i = a.SEARCH_ENGINES.filter(function (e) {
                        return !(
                          !e.hasOwnProperty("hostPattern") ||
                          !n.hostname.match(e.hostPattern)
                        );
                      }).shift())
                        ? {
                            valid: !0,
          ...
          dilInitConfigData: {
            ...
            componentData: {
              partner: {
                ...
                isRequired: true,
                description:
                  "Partner name as provided by Audience Manager. If this field is not autopopulated, then your org ID is probably not provisioned with Audience Manager.",
                  ...
                  savedData: {
                    ...
                    componentData: {
                      namespace: {
                        ...
                        isRequired: true,
                        description:
                          "Your company's Marketing Cloud Org ID. Should be autopopulated.",
                        isValueDisabled: false,
                      },
                    },
                  },
        ...
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/4bbb6b9dc376/99fc0f3e310e/hostedLibFiles/EPe480ba474d26429c973ab61d19be13b4/",
      },
      "adobe-mcid": {
          ...
          "adobe-mcid/src/lib/sharedModules/mcidInstance.js": {
            script: function (module, exports, require, turbine) {
              ...
              var initializeVisitorId = function (Visitor) {
                ...
                var initConfig = transformArrayToObject(
                ...
                if (doesOptInApply) {
                  if (typeof doesOptInApply === "boolean") {
                    ...
                    initConfig["doesOptInApply"] =
                      extensionSettings.optInCallback;
                  }
                }

                var isOptInStorageEnabled =
                  extensionSettings.isOptInStorageEnabled;
                ...
                if (preOptInApprovals) {
                  ...
                  var preOptInApprovalInput =
                    extensionSettings.preOptInApprovalInput;
                ...
                var instance = Visitor.getInstance(
                  extensionSettings.orgId,
                  initConfig,
                );

                turbine.logger.info(
                  'Created instance using orgId: "' +
                    extensionSettings.orgId +
                    '"',
                );
                turbine.logger.info(
                  "Set variables: " + JSON.stringify(initConfig),
                );
                ...
                instance.getMarketingCloudVisitorID(function (id) {
                  turbine.logger.info(
                    "Obtained Marketing Cloud Visitor Id: " + id,
                  );
                }, true);
              ...
              module.exports = (function () {
                var e = (function () {
                    ...
                    var e =
                      ...
                      n =
                        arguments.length > 1 && void 0 !== arguments[1]
                          ...
                          : {},
                      i = n.cookies;
                    if (!t || !i) return { get: Ne, set: Ne, remove: Ne };
                    var r = {
                      remove: function () {
                        i.remove(t);
                      },
                    ...
                    (e.fetchConsentData = function (e) {
                      ...
                      (e.isApproved = function (e) {
                        ...
                        if (i.transparencyAndConsentData)
                          return t(
                            null,
                            h(i.transparencyAndConsentData, pe[n], ge[n]),
                          );
                  ...
                  var S,
                    ...
                    U = (function (e, t) {
                      ...
                      (n.getIeVersion = function () {
                        ...
                        (n.parseOptOut = function (e, t, n) {
                          ...
                          return (
                            isNaN(i) && (i = 7200), { optOut: t, d_ottl: i }
                          );
                        }),
                    ...
                    Z = {
                      ...
                      set: function (e, t, n) {
                        ...
                        if (a && "SESSION" !== r && "NONE" !== r) {
                          ...
                          if (d)
                            (a = new Date()), a.setTime(a.getTime() + 1e3 * d);
                          else if (1 === a) {
                            a = new Date();
                            var f = a.getYear();
                    ...
                    se = function (e, t) {
                      ...
                      return {
                        ...
                        messagesPosted: [],
                        messagesReceived: [],
                        messageSendingInterval: oe.POST_MESSAGE_ENABLED
                          ? null
                          : 100,
                            ...
                            (this.throttleTimerSet ||
                              ...
                              setTimeout(function () {
                                r.messageSendingInterval =
                                  oe.POST_MESSAGE_ENABLED ? null : 150;
                              }, this.THROTTLE_START)),
                            (this.sendingMessages = !0),
                            this.sendMessages());
                        },
                        ...
                        checkFirstPartyCookie: function (t, n, i) {
                          ...
                          var o,
                            ...
                            l = !1,
                            d = Math.ceil(
                              new Date().getTime() / oe.MILLIS_PER_DAY,
                            );
                          c
                            ? ((o = c.split("*")),
                        ...
                        canMakeSyncIDCall: function (t, n) {
                          return (
                            e._forceSyncIDCall ||
                            !t ||
                            n - t > oe.DAYS_BETWEEN_SYNC_ID_CALLS
                          );
                        },
                    ...
                    Me = function (e) {
                      ...
                      return (
                        ...
                        be(e).every(function (e) {
                          return (
                            he.indexOf(e) > -1 || (t && me.indexOf(e) > -1)
                          );
                        })
                      );
                    },
                    ...
                    Pe = function (e) {
                      return (
                        void 0 === e || (we(e) ? Me(Object.keys(e), !0) : Re(e))
                      );
                    },
                    Re = function (e) {
                      try {
                        var t = JSON.parse(e);
                        return !!e && Ae(e, "string") && Me(Object.keys(t), !0);
                      } catch (e) {
                        return !1;
                      }
                    },
                    we = function (e) {
                      return (
                        null !== e && Ae(e, "object") && !1 === Array.isArray(e)
                      );
                    },
                    Ne = function () {},
                    xe = function (e) {
                      return Ae(e, "function") ? e() : e;
                    },
                    Fe = function (e, t) {
                  ...
                  var Je = function (t, n, i) {
                    ...
                    function l() {
                      return (
                        !!S.configs.doesOptInApply &&
                        !(I.optIn.isComplete && d())
                      );
                    }
                    function d() {
                    ...
                    n &&
                      ...
                      (S.cookieDomain = ee(null, M)),
                      (S.loadSSL = !0),
                      (S.loadTimeout = 3e4),
                      (S.CORSErrors = []),
                      (S.marketingCloudServer = S.audienceManagerServer =
                        "dpm.demdex.net"),
                    ...
                    (S.FIELDS = L.FIELDS),
                      ...
                      (S.cookieWrite = function (e, t, n) {
                        var i = S.cookieLifetime
                            ? ("" + S.cookieLifetime).toUpperCase()
                            : "",
                          r = {
                            expires: n,
                        ...
                        return (
                          ...
                          S.configs &&
                            ...
                            (r.sameSite =
                              L.SAME_SITE_VALUES[
                                S.configs.sameSiteCookie.toUpperCase()
                              ] || "Lax"),
                          Z.set(e, "" + t, r)
                        );
                      }),
                        ...
                        return (
                          S._isAllowedDone ||
                            ...
                            (S.cookieRead(S.cookieName) ||
                              ...
                              (S._isAllowedFlag = !0)),
                          "T" === S.cookieRead(S.cookieName) &&
                            S._helpers.removeCookie(S.cookieName),
                          S._isAllowedFlag
                        );
                      }),
                    ...
                    (S.getVisitorValues = function (e, t) {
                          ...
                          j(t) &&
                            ...
                            n.id &&
                              ...
                              void 0 != n.authState
                                ...
                                : (i.dataSources[t].authState =
                                    O.AuthState.UNKNOWN),
                              n.hashType &&
                                (i.dataSources[t].hashType = n.hashType)));
                          ...
                          j(t) &&
                            ...
                            n.id &&
                              ...
                              void 0 != n.authState
                                ...
                                : (i.nameSpaces[t].authState =
                                    O.AuthState.UNKNOWN),
                              n.hashType &&
                                (i.nameSpaces[t].hashType = n.hashType)));
                      ...
                      (S.getAnalyticsVisitorID = function (e, t, n) {
                        if (!G.isTrackingServerPopulated() && !n)
                      ...
                      (S.getSupplementalDataID = function (e, t) {
                        ...
                        return (
                          S._supplementalDataIDLast &&
                          !S._supplementalDataIDLastConsumed[e]
                            ...
                            : n &&
                              (S._supplementalDataIDCurrentConsumed[e] &&
                                ...
                                (S._supplementalDataIDCurrentConsumed = {})),
                              n &&
                                (S._supplementalDataIDCurrentConsumed[e] = !0)),
                          n
                        );
                      });
                    var B = !1;
                    (S._liberatedOptOut = null),
                      (S.getOptOut = function (e, t) {
                        ...
                        if (
                          ...
                          return (
                            S._callAllCallbacks("liberatedOptOut", [
                              S._liberatedOptOut,
                            ]),
                            (B = !1),
                            S._liberatedOptOut
                      ...
                      (S.isOptedOut = function (e, t, n) {
                        ...
                        return i
                          ? i === O.OptOut.GLOBAL || i.indexOf(t) >= 0
                          : null;
                      }),
                      (S._fields = null),
                      ...
                      (S._attemptToPopulateSdidFromUrl = function (e) {
                        var n = S._parseAdobeMcSdidFromUrl(e),
                          i = 1e9;
                        n && n.TS && (i = G.getTimestampInSeconds() - n.TS),
                          n &&
                            n.SDID &&
                            n.MCORGID === t &&
                            i < S.sdidParamExpiry &&
                            ((S._supplementalDataIDCurrent = n.SDID),
                            (S._supplementalDataIDCurrentConsumed.SDID_URL_PARAM =
                              !0));
                      }),
                      (S._attemptToPopulateIdsFromUrl = function () {
                        var e = S._parseAdobeMcFromUrl();
                        if (e && e.TS) {
                          var n = G.getTimestampInSeconds(),
                            i = n - e.TS;
                          if (
                            Math.floor(i / 60) > oe.ADOBE_MC_TTL_IN_MIN ||
                            e.MCORGID !== t
                          )
                            return;
                          o(e);
                        ...
                        if (e)
                          try {
                            if (
                              ...
                              !(function (e) {
                                G.isObject(e) && S.setCustomerIDs(e);
                              })(t.customerIDs),
                                s(t.sdid);
                            }
                          } catch (e) {
                      ...
                      (S._getSettingsDigest = function () {
                        if (!S._settingsDigest) {
                          var e = S.version;
                          S.audienceManagerServer &&
                            (e += "|" + S.audienceManagerServer),
                        ...
                        if (!S._readVisitorDone) {
                          ...
                          !S._getField(w) &&
                            ...
                            c.length > 1 &&
                              ...
                              i &&
                                i.match(oe.VALID_VISITOR_ID_REGEX) &&
                                S._setField(w, i)));
                        }
                      }),
                      ...
                      (S._findVisitorID = function (t) {
                        return (
                          t &&
                            ...
                            (t &&
                              (t === F ||
                                t.match(oe.VALID_VISITOR_ID_REGEX))) ||
                              (t = "")),
                          t
                        );
                      }),
                      ...
                      (S._getRemoteField = function (e, t, n, i, r) {
                        var a,
                          o = "",
                          s = G.isFirstPartyAnalyticsVisitorIDCall(e),
                        ...
                        if (d() && S.isAllowed()) {
                          ...
                          if (
                            (function () {
                              return (
                                (!o ||
                                  (S._fieldsExpired && S._fieldsExpired[e])) &&
                      ...
                      (S._setAudienceManagerFields = function (e) {
                        S._readVisitor(), S._setFields(N, e);
                      }),
                    ...
                    S._helpers = G;
                    var q = se(S, O);
                    (S._destinationPublishing = q), (S.timeoutMetricsLog = []);
                    var X = {
                    ...
                    (S.isClientSideMarketingCloudVisitorID = function () {
                      ...
                      (function () {
                        if (((S.configs = Object.create(null)), G.isObject(n)))
                          for (var e in n)
                            j(e) && ((S[e] = n[e]), (S.configs[e] = n[e]));
                      })(),
                      f();
                    var W;
                    S.init = function () {
                        ...
                        (function () {
                          if (G.isObject(n)) {
                            ...
                            S.idSyncDisableSyncs ||
                              ...
                              (S._setFieldExpire(x, -1), S._setField(P, t)),
        ...
        hostedLibFilesBaseUrl:
          "/perf/js/1281f6ff0c59/4bbb6b9dc376/99fc0f3e310e/hostedLibFiles/EPbba09bba93284cafa07ef329983e2c69/",
      },
    },
    company: {
      orgId: "97D1F3F459CE0AD80A495CBE@AdobeOrg",
    ...
    property: {
      name: "Benchmark: Analytics, Target, Audience Manager w/ Legacy Libraries",
      settings: {
        domains: ["alloyio.com"],
