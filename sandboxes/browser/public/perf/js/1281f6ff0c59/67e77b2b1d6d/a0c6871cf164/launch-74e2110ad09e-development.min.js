    ...
    extensions: {
      "adobe-mcid": {
                ...
                ((function () {
                  ...
                  function l(e, t) {
                    ...
                    var m,
                      ...
                      b,
                      y,
                      _ = L({ cookieName: "adobeujs-optin" }, { cookies: p }),
                      C = this,
                      I = H(C),
                      S = ue(),
                      A = Se(g),
                      ...
                      M =
                        ((y = E),
                        Ae(A) || (y && Ae(y)) ? B.COMPLETE : B.PENDING),
                      k =
                        ((m = D),
                        (h = A),
                        (v = E),
                    ...
                    (n.fetchConsentData = function (e) {
                      ...
                      (n.isApproved = function (e) {
                        ...
                        if (s.transparencyAndConsentData)
                          return n(
                            null,
                            g(s.transparencyAndConsentData, oe[r], ae[r]),
                          );
                  ...
                  var h,
                    ...
                    X = function (i, r) {
                      ...
                      return function (e) {
                        r.isInvalid(e) ||
                          (r.parse(e).prefix === x.HANDSHAKE ? s : c)(e.source);
                      };
                    },
                    K = function (r, n) {
                      function i(t) {
                    ...
                    re = function (g, t) {
                      ...
                      return {
                        ...
                        checkFirstPartyCookie: function (e, t, n) {
                          ...
                          s
                            ? ((o = s.split("*")),
                              (c = (a = this.pruneSyncData(o, e.id, l))
                                .dataPresent),
                              (u = a.dataValid),
                    ...
                    ye = function (e, t) {
                      ...
                      return (
                        ...
                        ve(e).every(function (e) {
                          return (
                            -1 < ce.indexOf(e) || (n && -1 < se.indexOf(e))
                          );
                        })
                      );
                    },
                    ...
                    Ae = function (e) {
                      return (
                        void 0 === e || (Ee(e) ? ye(Object.keys(e), !0) : De(e))
                      );
                    },
                    De = function (e) {
                      try {
                    ...
                    Ee = function (e) {
                      return (
                        null !== e && he(e, "object") && !1 === Array.isArray(e)
                      );
                    },
                    Oe = function () {},
                    Me = function (e) {
                  ...
                  (l.Categories = ie), (l.TimeoutError = u);
                  var je = Object.freeze({ OptIn: l, IabPlugin: m }),
                    Re = function (d, f) {
                  ...
                  var He = function (r, n, e) {
                    ...
                    function i(e) {
                      ...
                      t(e[M], v.setMarketingCloudVisitorID, M),
                        v._setFieldExpire(L, -1),
                        t(e[w], v.setAnalyticsVisitorID);
                    }
                    function o(e) {
                      (e = e || {}),
                    ...
                    (v.FIELDS = q.FIELDS),
                      ...
                      (v.getMarketingCloudVisitorID = function (e, t) {
                        ...
                        var n = v._getAudienceManagerURLData(
                          ...
                          r = n.url;
                        return v._getRemoteField(M, r, e, t, n);
                      });
                    var N = function (t, e) {
                      var n = {};
                    ...
                    (v.getVisitorValues = function (e, t) {
                      ...
                      (v.getAnalyticsVisitorID = function (e, t, n) {
                        ...
                        if (
                          ...
                          return (
                            (a.url = o),
                            v._getRemoteField(n ? M : w, o, e, t, a)
                          );
                        }
                        return "";
                      }),
                    ...
                    (v._liberatedOptOut = null),
                      ...
                      (v.isOptedOut = function (n, r, e) {
                        ...
                        return t
                          ? t === A.OptOut.GLOBAL || 0 <= t.indexOf(r)
                          : null;
                      }),
                      (v._fields = null),
                      ...
                      (v._addQuerystringParam = function (e, t, n, r) {
                        ...
                        var s = a.split("?"),
                          c = s[0] + "?",
                          u = s[1];
                        return c + V.addQueryParamAtLocation(u, i, r) + o;
                      }),
                        ...
                        if (!v._readVisitorDone) {
                          ...
                          if (
                            (c ||
                              ...
                              (c = v.cookieRead(ne.FIRST_PARTY_SERVER_COOKIE)),
                            null == v._fields && (v._fields = {}),
                            c && "T" !== c)
                          )
                            for (
                              (c = c.split("|"))[0].match(/^[\-0-9]+$/) &&
                                (parseInt(c[0], 10) !== a && (s = !0),
                                c.shift()),
                                c.length % 2 == 1 && c.pop(),
                                e = 0;
                              e < c.length;
                        ...
                        if (e === T) {
                          ...
                          (a && !v.overwriteCrossDomainMCIDAndAID) ||
                            ((a = v._findVisitorID(t))
                              ? a !== x && v._setFieldExpire(L, -1)
                              : (a = x),
                            v._setField(w, a)),
                            (a && a !== x) || (a = ""),
                            v._callAllCallbacks(w, [a]);
                        }
                    ...
                    var V = {
                      ...
                      removeCookie: function (e) {
                        z.remove(e, { domain: v.cookieDomain });
                      },
                          ...
                          (function () {
                            if (V.isObject(n)) {
                              ...
                              v.idSyncDisableSyncs ||
                                ...
                                (v._setFieldExpire(L, -1), v._setField(k, t)),
        ...
        settings: {
          ...
          variables: [
            { name: "idSyncDisableSyncs", value: "%disableIdSyncs%" },
          ],
        },
              ...
              e.exports = function (e) {
                ...
                switch (e.libraryCode.type) {
                  ...
                  case s.LIB_TYPES.PREINSTALLED:
                    return t
                      .then(
                        c.poll.bind(null, o, e.libraryCode.trackerVariableName),
                      )
                      .then(f.bind(null, e));
                  case s.LIB_TYPES.CUSTOM:
                  case s.LIB_TYPES.REMOTE:
...
var _satellite = (function () {
  ...
  if (window.atob) {
    var g = function (e) {
      ...
      M = D.bind(null, C.DEBUG),
      k = D.bind(null, C.WARN),
      T = D.bind(null, C.ERROR),
      w = {
        log: E,
        info: O,
        debug: M,
          ...
          function e(u) {
            ...
            function n(e, t, n) {
              if ("undefined" != typeof document) {
                "number" ==
                  typeof (n = c({ path: "/" }, s.defaults, n)).expires &&
      ...
      L = { get: P.get, set: P.set, remove: P.remove },
      x = window,
      j = "com.adobe.reactor.",
      R = function (r, e) {
        var i = j + (e || "");
      ...
      z = function (s, c, u, l) {
        return function (e, t) {
          ...
          if ("function" == typeof r) {
            ...
            return (
              i && (null != o ? X.setValue(e, i, o) : (o = X.getValue(e, i))),
    ...
    var ce = window.Promise || o["default"] || o,
      ...
      $e = (ze.decode, ze.parse, ze.encode, ze.stringify, "@adobe/reactor-"),
      Qe = {
        cookie: L,
        document: Ye,
        "load-script": We,
    ...
    if (nt && !window.__satelliteLoaded) {
      ...
      var ht = ie(nt),
        ...
        St = be(
          Ae(
            ot,
            me(ge(vt, Ee, yt, _t), Se(vt, Ct, It)),
            fe(le(vt, we, Ee, _t, yt), ue(vt, we, Ct), It),
            ht,
          ),
          vt,
          Re,
