  ...
  "function" != typeof window.DIL &&
    ((window.DIL = function (n, e) {
      ...
      n !== Object(n) && (n = {}),
        ...
        (a = n.visitorService),
        (d = n.declaredId),
        (l = !0 === n.delayAllUntilWindowLoad),
        (f = t(n.secureDataCollection)),
        (p = "boolean" == typeof n.isCoopSafe ? n.isCoopSafe : null),
        (y = t(n.enableHrefererParam)),
        (g = t(n.enableLogging)),
        (m = t(n.enableUrlDestinations)),
        (b = t(n.enableCookieDestinations)),
        (v = !0 === n.disableDefaultRequest),
        (D = n.afterResultForDefaultRequest),
        (C = n.visitorConstructor),
        (O = !0 === n.disableCORS),
        (S = !0 === n.ignoreHardDependencyOnVisitorAPI),
      ...
      if (
        ...
        c && ((r = 0), _.push(c), (c = "")),
        (i = DIL.getDil(I, r)) instanceof DIL &&
          i.api.getPartner() === I &&
          i.api.getContainerNSID() === r)
      )
        return i;
      ...
      L.IS_IE_LESS_THAN_10 =
        "number" == typeof L.IE_VERSION && L.IE_VERSION < 10;
      var A = { stuffed: {} },
        q = {},
        j = {
          firingQueue: [],
          ...
          registerRequest: function (e) {
            var t,
              n = this.firingQueue;
            e === Object(e) && (n.push(e), e.isDefaultRequest || (v = !0)),
              this.firing ||
                !n.length ||
                (l && !DIL.windowLoaded) ||
                ...
                this.adms.calledBack &&
                  ...
                  N.isPopulatedString(t.corsPostData) &&
      ...
      var T,
        ...
        V = {
          ...
          sendMessages: function () {
            this.sendingMessages ||
              ...
              m && this.messages.length && this.publishDestinations());
          },
          publishDestinations: function () {
            ...
            return 1 === this.publishDestinationsVersion
              ? (F.extendArray(i, this.messages),
                F.extendArray(this.messagesPosted, this.messages),
                t(),
                s.publishDestinations(I, i, e),
                "Called visitor.publishDestinations() version 1")
              : 1 < this.publishDestinationsVersion
                ? (F.extendArray(r, this.destinations),
                  F.extendArray(this.destinationsPosted, this.destinations),
                  t(),
        ...
        k = {
          traits: function (e) {
            return (
              N.isValidPdata(e) &&
                (q.sids instanceof Array || (q.sids = []),
                F.extendArray(q.sids, e)),
              this
            );
          },
          pixels: function (e) {
            return (
              N.isValidPdata(e) &&
                (q.pdata instanceof Array || (q.pdata = []),
                F.extendArray(q.pdata, e)),
              this
            );
          },
          logs: function (e) {
            return (
              N.isValidLogdata(e) &&
                (q.logdata !== Object(q.logdata) && (q.logdata = {}),
                F.extendObject(q.logdata, e)),
              this
            );
          },
          customQueryParams: function (e) {
            return (
              N.isEmptyObject(e) || F.extendObject(q, e, j.reservedKeys), this
            );
          },
          ...
          submit: function (e) {
            return (
              (q.isDefaultRequest = !!e), x.submitRequest(q), (q = {}), this
            );
          },
          getPartner: function () {
            return I;
          ...
          getState: function () {
            var e = {},
              t = {};
            return (
              F.extendObject(e, j, { registerRequest: !0 }),
              F.extendObject(t, V, {
                requestToProcess: !0,
                process: !0,
                sendMessages: !0,
          ...
          passData: function (e) {
            return N.isEmptyObject(e)
              ? "Error: json is empty or not an object"
              : (x.defaultCallback(e), e);
          },
            ...
            if (!n) {
              for (e in ((n = {}), s))
                s.hasOwnProperty(e) &&
                  ...
                  (n[e.replace(/^d_/, "")] = s[e]);
              !0 === p ? (n.coop_safe = 1) : !1 === p && (n.coop_unsafe = 1),
                (t.modStatsParams = n);
            }
            return n;
          },
        ...
        x = {
          ...
          createQueuedRequest: function (e) {
            ...
            return (
              N.isValidPdata(e.sids) || (e.sids = []),
              N.isValidPdata(e.pdata) || (e.pdata = []),
              N.isValidLogdata(e.logdata) || (e.logdata = {}),
              (e.logdataArray = F.convertObjectToKeyValuePairs(
                e.logdata,
                "=",
                !0,
              )),
            ...
            if (b && (n = e.stuff) && n instanceof Array && (s = n.length))
              for (i = 0; i < s; i++)
                (r = n[i]) &&
                  ...
                  (void 0 !== (d = r.ttl) && "" !== d) ||
                    (d = Math.floor(
                      F.getMaxCookieExpiresInMinutes() / 60 / 24,
                    )),
                  ...
                  o &&
                    ...
                    ("var" !== c &&
                      (d = parseInt(d, 10)) &&
                      !isNaN(d) &&
                      F.setCookie(o, a, 24 * d * 60, "/", u, !1),
                    (A.stuffed[o] = a)));
            var l,
              f,
              p = e.uuid;
            N.isPopulatedString(p) &&
              (N.isEmptyObject(h) ||
              ...
              j.abortRequests || V.requestToProcess(e, t);
          },
          makeRequestSrcData: function (r) {
            (r.sids = N.removeEmptyArrayValues(r.sids || [])),
              (r.pdata = N.removeEmptyArrayValues(r.pdata || []));
            var o = j,
              e = o.platformParams,
                    ...
                    B.instance.execute({
                      ...
                      callback: function (e, t) {
                        t === Object(t)
                          ...
                          (s.isVendorConsented = B.instance.isApproved(
                            B.instance.Categories.AAM,
                          )),
                          e ? n({}) : s.checkQueryStringObject(n),
                          U.adms.waitForMidToReleaseRequests();
                      },
                    }))
                  : n({});
            },
            getQueryString: function () {
              return B.isIabContext()
                ? "gdpr=" +
      ...
      var X = !1,
        K = function () {
          setTimeout(function () {
            v ||
              j.firstRequestHasFired ||
              ("function" == typeof D
                ? k.afterResult(D).submit(!0)
                : k.submit(!0));
      ...
      "error" !== I &&
        (DIL.windowLoaded
          ...
          : "complete" !== J.readyState && "loaded" !== J.readyState
            ...
            : ((DIL.windowLoaded = !0), s())),
        j.declaredId.setDeclaredId(d, "init"),
        Q.init(),
        W.init(),
        j.processVisitorAPI(),
        L.IS_IE_LESS_THAN_10 &&
          F.replaceMethodsWithFunction(k, function () {
            return this;
          }),
        (this.api = k),
        ...
        (this.constants = L),
        (this.log = _),
        (this.pendingRequest = q),
        (this.requestController = j),
        (this.destinationPublishing = V),
        (this.requestProcs = x),
        (this.units = w),
        (this.initConfig = n),
        (this.logger = P),
        R && ((this.variables = A), (this.callWindowLoadFunctions = s));
    }),
