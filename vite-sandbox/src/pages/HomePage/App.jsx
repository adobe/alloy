...
import { NoMatch } from "../ConfigPage/no-match";
...
function Layout() {
  return (
    <div>
      <h1>Welcome to the AEP Web SDK Sandbox!</h1>
      <nav>
        <ul>
          <li>
            <Link to="/">Home</Link>
          ...
          <li>
            {/* Use a normal <a> when linking to the "Inbox" app so the browser
                ...
                inbox/main.jsx. */}
            <a href="../ConfigPage">Configuration Page</a>
          </li>
        </ul>
      </nav>
...
function Home() {
  let orgId = React.createRef();
  let dataStreamId = React.createRef();
