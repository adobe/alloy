...
function Layout() {
  return (
    <div>
      <h1>Welcome to the AEP Web SDK Configuration Page!</h1>
      <nav>
        <ul>
          <li>
...
function Configuration() {
  ...
  return (
    <div>
            ...
            <div>
                <h3>{activeTab === "description" ? "There are many options that can be set during configuration. All options can be found below, grouped by category." : "Try It Out"}</h3>
                <form onSubmit={(e) => makeAPICall(e)}>
                    <div className={appStyles.table}>
                        ...
                        <div className={appStyles.row}>
                            ...
                            <div>Your assigned configuration ID, which links the SDK to the appropriate accounts and configuration. When configuring multiple instances within a single page, you must configure a different edgeConfigId for each instance.</div>
                        </div>
                        <div className={appStyles.row}>
                            ...
                            <div>
                                Indicates which context categories to collect automatically as described in Automatic Information. If this configuration is not specified, all categories are used by default.</div>
                        </div>
                        ...
                        <div className={appStyles.row}>
                            ...
                            <div>
                                Indicates whether debugging is enabled. Setting this config to true enables the following features:</div>
                        </div>
                        ...
                        <div className={appStyles.row}>
                            ...
                            <div>
                                Populate this field with your first-party domain. For more details, please see the documentation. The domain is similar to data.customerdomain.com for a website at www.customerdomain.com.              </div>
                        </div>
                        <div className={appStyles.row}>
                            <div className={cx(appStyles.arg, appStyles.required)}>
                                orgId
                            ...
                            <div>
                                Your assigned Experience Cloud organization ID. When configuring multiple instances within a page, you must configure a different orgId for each instance.</div>
                        </div>
                    </div>
                    ...
                    <div className={appStyles.table}>
                        ...
                        <div className={appStyles.row}>
                            ...
                            <div>Indicates whether data associated with link clicks are automatically collected. See Automatic Link Tracking for more information. Links are also labeled as download links if they include a download attribute or if the link ends with a file extension. Download link qualifiers can be configured with a regular expression. The default value is "\\.(exe|zip|wav|mp3|mov|mpg|avi|wmv|pdf|doc|docx|xls|xlsx|ppt|pptx)$"</div>
                        </div>
                        <div className={appStyles.row}>
                    ...
                    <div className={appStyles.table}>
                        ...
                        <div className={appStyles.row}>
                            ...
                            <div>Sets the user’s default consent. Use this setting when there is no consent preference already saved for the user. The other valid values are "pending" and "out". This default value is not persisted to the user’s profile. The user’s profile is updated only when setConsent is called.</div>
                        </div>
                    </div>
                    ...
                    <div className={appStyles.table}>
                        ...
                        <div className={appStyles.row}>
                            ...
                            <div>Used to create a CSS style definition that hides content areas of your web page while personalized content is loaded from the server. If this option is not provided, the SDK does not attempt to hide any content areas while personalized content is loaded, potentially resulting in “flicker”.</div>
                        </div>
                    </div>
                            ...
                            {activeTab === "tester" && (
                                <div>
                                    <input
                                        className={appStyles.value}
                                        type="checkbox"
                                        onChange={(e) => updateSubresources("cookieDestinationsEnabled")}
                                    ></input>
                                </div>
                            )}
                            <div>Enables Audience Manager cookie destinations, which allows the setting of cookies based on segment qualification.</div>
                        </div>
                        <div className={appStyles.row}>
                            ...
                            <div>Enables Audience Manager URL destinations, which allows the firing of URLs based on segment qualification.</div>
                        </div>
                    </div>
                            ...
                            {activeTab === "tester" && (
                                <div>
                                    <input
                                        className={appStyles.value}
                                        type="checkbox"
                                        onChange={(e) => updateSubresources("thirdPartyCookiesEnabled")}
                                    ></input>
                                </div>
                            )}
                            <div>Enables the setting of Adobe third-party cookies. The SDK can persist the visitor ID in a third-party context to enable the same visitor ID to be used across sites. Use this option if you have multiple sites or you want to share data with partners; however, sometimes this option is not desired for privacy reasons.</div>
                        </div>
                    </div>
                                                    ...
                                                    "payload": [
                                                        {
                                                            ...
                                                            "value": "CiY5MTQ0MDg5MjEwMzIzMzc3MTc4MDMxNTA2MzYzNzEzMTA0MTk0N1IOCPmsht7JLxgBKgNWQTagAfmsht7JL_AB-ayG3skv",
                                                            "maxAge": 34128000
                                                        },
                                                        {
                                                        ...
                                                        {
                                                            "key": "kndctr_5BFE274A5F6980A50A495C08_AdobeOrg_consent_check",
                                                            "value": "1",
                                                            "maxAge": 7200
                                                        }
                                                    ],
                                            ...
                                            "warnings": [
                                                {
                                                    ...
                                                    "status": 200,
                                                    "detail": "Unable to process this request due to lack of user consent.",
