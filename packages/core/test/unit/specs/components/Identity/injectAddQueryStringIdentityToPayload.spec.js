...
describe("Identity::injectAddQueryStringIdentityToPayload", () => {
  ...
  describe("with mock payload", () => {
    ...
    it("doesn't do anything when there is no TS parameter", () => {
      locationSearch = `?adobe_mc=${encodeURIComponent("MCMID=myid|MCORG=myorg")}`;
      run();
      expect(payload.addIdentity).not.toHaveBeenCalled();
    });
    ...
    [
      ...
      "adobe_mc=a%3Db",
      "adobe_mc=%7C%7C",
      `adobe_mc=${encodeURIComponent("TS=foo|MCMID=12345|MCORGID=FAF554945B90342F0A495E2C@AdobeOrg")}`,
      `adobe_mc=${encodeURIComponent("TS=1641432103|MCMID=|MCORGID=FAF554945B90342F0A495E2C@AdobeOrg")}`,
