...
describe("createBuildEndpointUrl", () => {
  ...
  it("builds URL with request parameters", () => {
    queryStringMock.stringify.mockReturnValue(
      "existingParam=value&requestId=test-request-id&configId=test-datastream",
    );
    ...
    expect(result).toBe(
      "https://edge.adobedc.net/v1/conversation/chat?existingParam=value&requestId=test-request-id&configId=test-datastream",
    );
  });
  ...
  it("uses datastream override when available", () => {
    ...
    queryStringMock.stringify.mockReturnValue(
      "existingParam=value&requestId=test-request-id&configId=override-datastream",
    );
    ...
    expect(result).toBe(
      "https://edge.adobedc.net/v1/conversation/chat?existingParam=value&requestId=test-request-id&configId=override-datastream",
    );
  });
