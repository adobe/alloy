            ...
            if (babelPath.node.name === "callFake") {
              ...
              if (callExpressionPath) {
                ...
                if (parentPath.isMemberExpression()) {
                  ...
                  babelPath.replaceWith(t.identifier(`mock.calls[${args[0]}]`));
                }
              }
            }
          },
              ...
              for (let a = 0; a < args.length; a += 1) {
                ...
                if (obj && obj.type === "ObjectExpression") {
                  ...
                  for (let i = 0; i < objectProperties.length; i += 1) {
                    ...
                    newProps.push(
                      t.objectProperty(
                        t.identifier(objectProperties[i].get("key").node.name),
                        t.callExpression(
                          t.memberExpression(
                            t.callExpression(
                              t.memberExpression(
