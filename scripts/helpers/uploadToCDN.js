...
`;
  ...
  await exec("sftp", `echo "${ftpCommands}" | sftp -oHostKeyAlgorithms=+ssh-dss -oStrictHostKeyChecking=no -b - sshacs@dxresources.ssh.upload.akamai.com:/prod/alloy`);

  await ensureUrlResolves(`https://cdn1.adoberesources.net/alloy/${version}/alloy.js`);
  await ensureUrlResolves(`https://cdn1.adoberesources.net/alloy/${version}/alloy.min.js`);
};
