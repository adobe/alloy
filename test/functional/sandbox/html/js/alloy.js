...
(function(factory) {
  ...
  var createIdentity = function createIdentity(_ref) {
    ...
    var _setCustomerIds = function setCustomerIds(ids) {
      ...
      var customerIdsHash = crc32(
        JSON.stringify(normalizedCustomerIds)
      ).toString(36); // TODO: add more tests around this piece

      var customerIdChanged =
      ...
      lifecycle: {
        ...
        onResponse: function onResponse(response) {
          return optIn.whenOptedIn().then(function() {
            ...
            idSyncs.process(
              flatMap(response.getPayloadsByType("identity:exchange"), function(
                fragment
              ) {
                return fragment;
              })
