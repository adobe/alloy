...
createFixture({
  title:
    "Test C13412101: Verify that no DOM action occur using evaluateRulesets when ruleset are not satisfied",
...
test("Test C13412101: Verify that no DOM action occur using evaluateRulesets when ruleset are not satisfied", async () => {
  ...
  await t.expect(containerElement).contains("");
});
