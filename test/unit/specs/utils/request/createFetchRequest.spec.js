...
*/
import { createFetchRequest } from "../../../../../src/utils/request";
import describeRequest from "../../../helpers/describeRequest";

describe("createDataCollectionRequest", () => {
  describeRequest(createFetchRequest);

  it("returns fetch as the endpoint", () => {
    const payload = {
    ...
    expect(request.getAction()).toEqual("fetch");
  });

  it("doesn't use sendBeacon", () => {
    const payload = {
      getDocumentMayUnload() {
        return true;
      }
