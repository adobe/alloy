...
describe("Personalization::onResponseHandler", () => {
  ...
  it("should execute DOM ACTION decisions and return rest of decisions", () => {
    const expectedResult = {
      decisions: PAGE_WIDE_SCOPE_DECISIONS_WITHOUT_DOM_ACTION_SCHEMA_ITEMS
    };
    ...
    expect(executeDecisions).toHaveBeenCalled();
    expect(result).toEqual(expectedResult);
  });

  it("should not trigger executeDecisions and should return all decisions", () => {
    const expectedResult = {
