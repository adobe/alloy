  ...
  it("works with real response", () => {
    const handle = {
      ...
      "scopeDetails": {
        ...
        "characteristics": {
          "eventToken": "8CwxglIqrTLmqP2m1r52VWqipfsIHvVzTQxHolz2IpTMromRrB5ztP5VMxjHbs7c6qPG9UF4rvQTJZniWgqbOw=="
        }
      },
      "items": [
        {
          ...
          "data": {
            ...
            "content": "https://alloyio.com/functional-test/alloyTestPage.html?redirectedTest=true&test=C205528"
          }
        }
      ]
    };
    ...
    expect(proposition.getRedirectUrl()).toEqual("https://alloyio.com/functional-test/alloyTestPage.html?redirectedTest=true&test=C205528");
    ...
    expect(propositions[0].id).toEqual("AT:eyJhY3Rpdml0eUlkIjoiMTI3ODE5IiwiZXhwZXJpZW5jZUlkIjoiMCJ9");

    const notifications = [];
    proposition.addToNotifications(notifications);
    expect(notifications.length).toEqual(1);
    expect(notifications[0].id).toEqual("AT:eyJhY3Rpdml0eUlkIjoiMTI3ODE5IiwiZXhwZXJpZW5jZUlkIjoiMCJ9");
  });
});
