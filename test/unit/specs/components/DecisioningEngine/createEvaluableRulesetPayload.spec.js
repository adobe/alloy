...
describe("DecisioningEngine:createEvaluableRulesetPayload", () => {
  ...
  it("evaluates global context and return consequences", () => {
    const ruleset = RulesEngine({
      version: 1,
      rules: [
        {
  ...
  it("evaluates global context and return empty consequence", () => {
    const ruleset = RulesEngine({
      version: 1,
      rules: [
        {
